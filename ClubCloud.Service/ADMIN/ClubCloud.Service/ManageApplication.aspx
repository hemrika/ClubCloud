...
<asp:Content ID="contentPageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server">
    <a href="/_admin/ServiceApplications.aspx">
        <SharePoint:EncodedLiteral runat="server" Text="<%$Resources:spadmin, svcappsadm_pagetitle%>" EncodeMethod='HtmlEncode' /></a> :
    <asp:Literal ID="literalPageTitleInTitleArea" runat="server" Text='<%$ Resources: ClubCloud.Service.ServiceAdminResources, ApplicationManagementPageTitleInTitleArea %>' Mode="PassThrough"></asp:Literal>
</asp:Content>
    ...
    <asp:Panel ID="panelMain" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="ms-propertysheet">
            ...
            <wssuc:InputFormSection Title='<%$ Resources: ClubCloud.Service.ServiceAdminResources, ApplicationManagementMetaDataSettingsSectionTitle %>' ID="metadataConfigSection" runat="server" Description='<%$ Resources:ClubCloud.Service.ServiceAdminResources, ApplicationManagementMetaDataSettingsSectionDescription %>'>
                ...
                <wssuc:InputFormControl LabelText="" runat="server">
                    <Template_control>
                        <asp:HyperLink ID="hyperlinkmetadataSettings" runat="server" NavigateUrl='<%# GenerateLink("ManageMetaData.aspx") %>' Text='<%$ Resources: ClubCloud.Service.ServiceAdminResources, ApplicationManagementMetaDataSettingsButtonText %>'></asp:HyperLink>
                    </Template_control>
                </wssuc:InputFormControl>
            </template_inputformcontrols>
            </wssuc:InputFormSection>
            <wssuc:InputFormSection Title='ClubCloud Store' ID="storeConfigSection" runat="server" Description='ClubCloud Store management'>
                <template_inputformcontrols>
                <wssuc:InputFormControl LabelText="" runat="server">
                    <Template_control>
                        <asp:HyperLink ID="hyperlinkstoreSettings" runat="server" NavigateUrl='<%# GenerateLink("ManagePackages.aspx") %>' Text='Manage Store'></asp:HyperLink>
                    </Template_control>
                </wssuc:InputFormControl>
            </template_inputformcontrols>
            </wssuc:InputFormSection>
