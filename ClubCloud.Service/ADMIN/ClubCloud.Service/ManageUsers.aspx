...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="ClubCloud.Service.Administration.ManageUsersPage" MasterPageFile="~/_admin/admin.master" %>
            ...
            <template_inputformcontrols>
                <wssuc:InputFormControl LabelText="" runat="server">
                    <Template_control>				        
                        ...
                        <asp:GridView CssClass="ms-listviewtable" GridLines="None" Cellspacing="0" Cellpadding="0" HeaderStyle-CssClass="ms-viewheadertr" AlternatingRowStyle-CssClass="ms-alternatingstrong" ID="gvw_users" runat="Server" AutoGenerateColumns="false" Width="100%">
                            <Columns>
                                ...
                                <asp:BoundField HeaderStyle-CssClass="ms-vh2-nofilter ms-vh2-gridview" ItemStyle-CssClass="ms-vb2" HeaderText="<%$ Resources: ClubCloud.Service.ServiceAdminResources, ManageServiceApplicationNameHeaderText %>" DataField="GebruikerId" />
                                <asp:BoundField HeaderStyle-CssClass="ms-vh2-nofilter ms-vh2-gridview" ItemStyle-CssClass="ms-vb2" HeaderText="<%$ Resources: ClubCloud.Service.ServiceAdminResources, ManageServiceApplicationNameHeaderText %>" DataField="VerenigingId" />
                                <asp:BoundField HeaderStyle-CssClass="ms-vh2-nofilter ms-vh2-gridview" ItemStyle-CssClass="ms-vb2" HeaderText="<%$ Resources: ClubCloud.Service.ServiceAdminResources, ManageServiceApplicationNameHeaderText %>" DataField="FunctieId" />
