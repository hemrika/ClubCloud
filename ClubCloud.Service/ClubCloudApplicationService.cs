...
*/
        ...
        /// <param name="target"></param>
        /// <returns></returns>
        private Guid CreateEntity(ClubCloud.KNLTB.ServIt.CrmService.CrmService service, TargetCreate target)
        {
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        ...
                        {
                            sgt_alg_accommodatie accommodatie = RetrieveEntity(service, new TargetRetrieveSgt_alg_accommodatie { EntityId = Id }) as sgt_alg_accommodatie;
                ...
                if (entity.Id != Guid.Empty)
                {
                    ...
                    if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                    {
                        ...
                        if (cc != null)
                        {
                            using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                            {
                                sgt_alg_accommodatie accommodatie = RetrieveEntity(service, new TargetRetrieveSgt_alg_accommodatie { EntityId = entity.Id }) as sgt_alg_accommodatie;// "sgt_alg_accommodatie", out moreRecords, ref pageNum, expression);

                                if (accommodatie != null && accommodatie.sgt_alg_accommodatieid.Value == entity.Id)
                                {
                                    EntityToAccommodatie(accommodatie, entity, settings);
        ...
        private List<ClubCloud_Vereniging> GetVerenigingenForAccommodatieById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            ClubCloud_Accommodatie accommodatie = beheerModel.ClubCloud_Accommodaties.Find(Id);
        ...
        private List<ClubCloud_Baanblok> GetBaanblokkenForAccommodatieById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            baanblokken = beheerModel.ClubCloud_Baanblokken.Where(b => b.AccommodatieId.Value == Id).ToList();
        ...
        private List<ClubCloud_Baan> GetBanenForAccommodatieById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            if (accommodatie != null)
            {
                ...
                banen = accommodatie.ClubCloud_Baan.ToList();
                ...
                if (banen == null || banen.Count == 0 || banen.Count != accommodatie.BanenAantal || refresh)
                {
                            ...
                            using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                            {
                                ...
                                while (moreRecords)
                                {
                                    ...
                                    foreach (sgt_alg_baan entity in entities)
                                    {
                                        ...
                                        {
                                            ClubCloud_Baanblok baanblok = GetBaanblokById(entity.sgt_baanblokid.Value, refresh, settings); //GetBaanblokById(bondsnummer, entity.sgt_baanblokid.Value, false, settings);
                                            if (baanblok != null)
                    ...
                    banen = beheerModel.ClubCloud_Banen.Where(b => b.AccommodatieId.Value == Id).ToList();
                }
            }
            return banen;
        }
        ...
        */
                        ...
                        if (cc != null)
                        {
                            using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                            {
                                ...
                                while (moreRecords)
                                {
                                    ...
                                    {
                                        ClubCloud_BaanSpeciaal entity = beheerModel.ClubCloud_BanenSpeciaal.Create();
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForAccommodatie(string bondsnummer, ClubCloud_Accommodatie entity, bool refresh, ClubCloud_Setting settings)
        {
            return GetAddressesForAccommodatieById(bondsnummer, entity.Id, refresh, settings);
        }
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForAccommodatieById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            if (accommodatie != null)
            {
                if (accommodatie.ClubCloud_Address == null || accommodatie.ClubCloud_Address.Count == 0)
                {
                    result = beheerModel.ClubCloud_Addresses.Where(b => b.ParentId.Value == Id).ToList();

                    foreach (ClubCloud_Address address in result)
                    {
                        accommodatie.ClubCloud_Address.Add(address);
                    }
                    beheerModel.SaveChanges();
                }
            }
        ...
        */
        ...
        private void AccommodatieToEntity(sgt_alg_accommodatie accommodatie, ClubCloud_Accommodatie entity, ClubCloud_Setting settings)        
        {
            ...
            */
            ...
            {
                List<ClubCloud_Address> addressen = GetAddressesForAccommodatieById(settings.Id.ToString(), accommodatie.sgt_alg_accommodatieid.Value, false, settings);
                    ...
                    foreach (ClubCloud_Address addr in addressen)
                    {
                        ...
                        if (address.Naam.Equals("Bezoekadres", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ...
                            if (accommodatie.sgt_bezoekadreslandcodeid != null)
                                address.Land = accommodatie.sgt_bezoekadreslandcodeid.name;
                            //address.Latitude
                            //address.Longitude
                            address.Nummer = accommodatie.sgt_bezoekadres_huisnummer;
                            if (accommodatie.sgt_alg_accommodatieid != null)
                                address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                            //address.Postbus
                            address.Gemeente = accommodatie.sgt_bezoekadres_gemeente;
                            address.Postcode = accommodatie.sgt_bezoekadres_postcode;
                            address.Provincie = accommodatie.sgt_bezoekadres_gemeente;
                            address.Stad = accommodatie.sgt_bezoekadres_plaats;
                            address.Straat = accommodatie.sgt_bezoekadres_straat;
                            //address.TelefoonPrimair
                            //address.TelefoonSecundair
                            //address.TelefoonTertiair
                            address.Toevoeging = accommodatie.sgt_bezoekadres_toevoeging;
                            address.Actief = accommodatie.statuscode.name;
                        ...
                        if (address.Naam.Equals("Postadres", StringComparison.InvariantCultureIgnoreCase))
                        {
                            //address.Fax
                            if (accommodatie.sgt_bezoekadreslandcodeid != null)
                                address.Land = accommodatie.sgt_postadreslandcodeid.name;
                            //address.Latitude
                            //address.Longitude
                            address.Nummer = accommodatie.sgt_postadres_huisnummer;
                            if (accommodatie.sgt_alg_accommodatieid != null)
                                address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                            //address.Postbus
                            address.Gemeente = accommodatie.sgt_postadres_gemeente;
                            address.Postcode = accommodatie.sgt_postadres_postcode;
                            address.Provincie = accommodatie.sgt_postadres_gemeente;
                            address.Stad = accommodatie.sgt_postadres_plaats;
                            address.Straat = accommodatie.sgt_postadres_straat;
                            //address.TelefoonPrimair
                            //address.TelefoonSecundair
                            //address.TelefoonTertiair
                            address.Toevoeging = accommodatie.sgt_postadres_toevoeging;
                            address.Actief = accommodatie.statuscode.name;
                            address.Gewijzigd = DateTime.Now;
                        }
                        beheerModel.SaveChanges();
                ...
                else
                {
                    ...
                    bezoek_address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                    bezoek_address.Naam = "Bezoekadres";
                    //bezoek_address.Fax
                    if (accommodatie.sgt_bezoekadreslandcodeid != null)
                        bezoek_address.Land = accommodatie.sgt_bezoekadreslandcodeid.name;
                    //bezoek_address.Latitude
                    //bezoek_address.Longitude
                    bezoek_address.Nummer = accommodatie.sgt_bezoekadres_huisnummer;
                    if (accommodatie.sgt_alg_accommodatieid != null)
                        bezoek_address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                    //bezoek_address.Postbus
                    bezoek_address.Gemeente = accommodatie.sgt_bezoekadres_gemeente;
                    bezoek_address.Postcode = accommodatie.sgt_bezoekadres_postcode;
                    bezoek_address.Provincie = accommodatie.sgt_bezoekadres_gemeente;
                    bezoek_address.Stad = accommodatie.sgt_bezoekadres_plaats;
                    bezoek_address.Straat = accommodatie.sgt_bezoekadres_straat;
                    //bezoek_address.TelefoonPrimair
                    //bezoek_address.TelefoonSecundair
                    //bezoek_address.TelefoonTertiair
                    bezoek_address.Toevoeging = accommodatie.sgt_bezoekadres_toevoeging;
                    bezoek_address.Actief = accommodatie.statuscode.name;
                    bezoek_address.Gewijzigd = DateTime.Now;
                    beheerModel.ClubCloud_Addresses.Add(bezoek_address);
                    beheerModel.SaveChanges();

                    entity.ClubCloud_Address.Add(bezoek_address);

                    ClubCloud_Address post_address = beheerModel.ClubCloud_Addresses.Create();

                    post_address.Id = Guid.NewGuid();
                    post_address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                    post_address.Naam = "Postadres";
                    //post_address.Fax
                    if (accommodatie.sgt_postadreslandcodeid != null)
                        post_address.Land = accommodatie.sgt_postadreslandcodeid.name;
                    //post_address.Latitude
                    //post_address.Longitude
                    post_address.Nummer = accommodatie.sgt_postadres_huisnummer;
                    if (accommodatie.sgt_alg_accommodatieid != null)
                        post_address.ParentId = accommodatie.sgt_alg_accommodatieid.Value;
                    //post_address.Postbus
                    post_address.Gemeente = accommodatie.sgt_postadres_gemeente;
                    post_address.Postcode = accommodatie.sgt_postadres_postcode;
                    post_address.Provincie = accommodatie.sgt_postadres_gemeente;
                    post_address.Stad = accommodatie.sgt_postadres_plaats;
                    post_address.Straat = accommodatie.sgt_postadres_straat;
                    //post_address.TelefoonPrimair
                    //post_address.TelefoonSecundair
                    //post_address.TelefoonTertiair
                    post_address.Toevoeging = accommodatie.sgt_postadres_toevoeging;
                    post_address.Actief = accommodatie.statuscode.name;
                    post_address.Gewijzigd = DateTime.Now;
                    beheerModel.ClubCloud_Addresses.Add(post_address);
                    beheerModel.SaveChanges();

                    entity.ClubCloud_Address.Add(post_address);
                }
            }
        }
        ...
        /// <param name="entity"></param>
        /// <param name="accommodatie"></param>
        private void EntityToAccommodatie(sgt_alg_accommodatie entity, ClubCloud_Accommodatie accommodatie, ClubCloud_Setting settings)
        {
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            customeraddress address = RetrieveEntity(service, new TargetRetrieveCustomerAddress { EntityId = Id }) as customeraddress;

                            if (address != null && address.customeraddressid.Value == Id)
                            {
                                entity = beheerModel.ClubCloud_Addresses.Create();
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddresses(string bondsnummer, bool refresh, ClubCloud_Setting settings)
        {
            throw new NotImplementedException();
        }
                ...
                if (entity.Id != Guid.Empty)
                {
                    ...
                    if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                    {
                        ...
                        if (cc != null)
                        {
                            using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                            {
                                customeraddress found = RetrieveEntity(service, new TargetRetrieveCustomerAddress { EntityId = entity.Id }) as customeraddress;

                                if (found != null && found.customeraddressid.Value == entity.Id)
                                {
                                    EntityToAddress(found, entity);
        ...
        private ClubCloud_Vereniging GetVerenigingForAddressById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            ClubCloud_Address address = beheerModel.ClubCloud_Addresses.Find(Id);
            if (address != null)
            {
        ...
        */
        ...
        private void EntityToAddress(customeraddress address, ClubCloud_Address entity)
        {
        ...
        /// <param name="address"></param>
        /// <param name="entity"></param>
        private void AddressToEntity(customeraddress address, ClubCloud_Address entity)
        {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            sgt_alg_baan baan = RetrieveEntity(service, new TargetRetrieveSgt_alg_baan { EntityId = Id }) as sgt_alg_baan;
                ...
                if (entity.Id != Guid.Empty)
                {
                    ...
                    if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                    {
                        ...
                        if (cc != null)
                        {
                            using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                            {
                                sgt_alg_baan found = RetrieveEntity(service, new TargetRetrieveSgt_alg_baan { EntityId = entity.Id }) as sgt_alg_baan;
        ...
        private ClubCloud_Baanblok GetBaanblokForBaanById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            ClubCloud_Baan baan = beheerModel.ClubCloud_Banen.Find(Id);
            if (baan != null)
            {
        ...
        /// <param name="baan"></param>
        /// <param name="entity"></param>
        private void BaanToEntity(sgt_alg_baan baan, ClubCloud_Baan entity, ClubCloud_Setting settings = null)
        {
        ...
        private ClubCloud_Baanblok GetBaanblokById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
            {
                ...
                if (cc != null)
                {
                    using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                    {
                        sgt_alg_baanblok baanblok = RetrieveEntity(service, new TargetRetrieveSgt_alg_baanblok { EntityId = Id }) as sgt_alg_baanblok;
        ...
        {
            List<ClubCloud_Baanblok> baanblokken = null;
        ...
        private List<ClubCloud_Baan> GetBanenForBaanblokById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            ...
            ClubCloud_Baanblok baanblok = beheerModel.ClubCloud_Baanblokken.Find(Id);
            if (baanblok != null)
            {
        ...
        private void BaanblokToEntity(sgt_alg_baanblok baanblok, ClubCloud_Baanblok entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = baanblok.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_baansoort baansoort = RetrieveEntity(service, new TargetRetrieveSgt_alg_baansoort { EntityId = Id }) as sgt_alg_baansoort;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Baansoort entity = beheerModel.ClubCloud_Baansoorten.Create();
                                    entity.Id = baansoort.sgt_alg_baansoortid.Value;
        ...
        private void BaansoortToEntity(sgt_alg_baansoort baansoort, ClubCloud_Baansoort entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = baansoort.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_speciale_baan specialebaan = RetrieveEntity(service, new TargetRetrieveSgt_alg_speciale_baan { EntityId = Id }) as sgt_alg_speciale_baan;
                            ...
                            while (moreRecords)
                            {
                                ConditionExpression condition = new ConditionExpression { AttributeName = "sgt_alg_speciale_baanid", Operator = ConditionOperator.Equal, Values = new object[1] { Id } };
                                FilterExpression expression = new FilterExpression { FilterOperator = LogicalOperator.And, Conditions = new ConditionExpression[1] { condition } };
        ...
        private void BaanspeciaalToEntity(sgt_alg_speciale_baan specialebaan, ClubCloud_BaanSpeciaal entity, ClubCloud_Setting settings)
        {
            ...
            {
                entity.Baansoort = specialebaan.sgt_soort_baan.name;
            }
            ...
            entity.Actief = specialebaan.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_toplaag toplaag = RetrieveEntity(service, new TargetRetrieveSgt_alg_toplaag { EntityId = Id }) as sgt_alg_toplaag;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Baantoplaag entity = beheerModel.ClubCloud_Baantoplagen.Create();
                                    entity.Id = toplaag.sgt_alg_toplaagid.Value;
                                    BaantoplaagToEntity(toplaag, entity, settings);
                                    beheerModel.ClubCloud_Baantoplagen.AddOrUpdate(entity);
        ...
        private void BaantoplaagToEntity(sgt_alg_toplaag toplaag, ClubCloud_Baantoplaag entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = toplaag.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_baantype baantype = RetrieveEntity(service, new TargetRetrieveSgt_alg_baantype { EntityId = Id }) as sgt_alg_baantype;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Baantype entity = beheerModel.ClubCloud_Baantypes.Create();
                                    entity.Id = baantype.sgt_alg_baantypeid.Value;
                                    BaantypeToEntity(baantype, entity, settings);
                                    beheerModel.ClubCloud_Baantypes.AddOrUpdate(entity);
        ...
        private void BaantypeToEntity(sgt_alg_baantype baantype, ClubCloud_Baantype entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = baantype.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_bestuursorgaan bestuursorgaan = RetrieveEntity(service, new TargetRetrieveSgt_alg_bestuursorgaan { EntityId = Id }) as sgt_alg_bestuursorgaan;
                            ...
                            while (moreRecords)
                            {
                                ConditionExpression condition = new ConditionExpression { AttributeName = "sgt_alg_bestuursorgaanid", Operator = ConditionOperator.Equal, Values = new object[1] { Id } };
                                FilterExpression expression = new FilterExpression { FilterOperator = LogicalOperator.And, Conditions = new ConditionExpression[1] { condition } };
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Bestuursorgaan entity = beheerModel.ClubCloud_Bestuursorganen.Create();
                                    entity.Id = bestuursorgaan.sgt_alg_bestuursorgaanid.Value;
                                    BestuursorgaanToEntity(bestuursorgaan, entity, settings);
                                    beheerModel.ClubCloud_Bestuursorganen.AddOrUpdate(entity);
        ...
        private void BestuursorgaanToEntity(sgt_alg_bestuursorgaan bestuursorgaan, ClubCloud_Bestuursorgaan entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = bestuursorgaan.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_bouwaard bouwaard = RetrieveEntity(service, new TargetRetrieveSgt_alg_bouwaard { EntityId = Id }) as sgt_alg_bouwaard;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Bouwaard entity = beheerModel.ClubCloud_Bouwaarden.Create();
                                    entity.Id = bouwaard.sgt_alg_bouwaardid.Value;
                                    BouwaardToEntity(bouwaard, entity, settings);
                                    beheerModel.ClubCloud_Bouwaarden.AddOrUpdate(entity);
                                }
        ...
        private void BouwaardToEntity(sgt_alg_bouwaard bouwaard, ClubCloud_Bouwaard entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = bouwaard.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_district district = RetrieveEntity(service, new TargetRetrieveSgt_alg_district { EntityId = Id }) as sgt_alg_district;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_District entity = beheerModel.ClubCloud_Districten.Create();
                                    entity.Id = district.sgt_alg_districtid.Value;
                                    DistrictToEntity(district, entity, settings);
                                    beheerModel.ClubCloud_Districten.AddOrUpdate(entity);
        ...
        private void DistrictToEntity(sgt_alg_district district, ClubCloud_District entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = district.statuscode.name;
        }
        ...
        */
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_functie functie = RetrieveEntity(service, new TargetRetrieveSgt_alg_functie { EntityId = Id }) as sgt_alg_functie;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Functie entity = beheerModel.ClubCloud_Functies.Create();
                                    entity.Id = functie.sgt_alg_functieid.Value;
                                    FunctieToEntity(functie, entity, settings);
                                    beheerModel.ClubCloud_Functies.AddOrUpdate(entity);
        ...
        private void FunctieToEntity(sgt_alg_functie functie, ClubCloud_Functie entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = functie.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_functionaris functionaris = RetrieveEntity(service, new TargetRetrieveSgt_alg_functionaris { EntityId = Id }) as sgt_alg_functionaris;
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            ...
                            while (moreRecords)
                            {
                                ...
                                {
                                    ClubCloud_Functionaris entity = beheerModel.ClubCloud_Functionarissen.Create();
                                    entity.Id = functionaris.sgt_alg_functionarisid.Value;
                                    FunctionarisToEntity(functionaris, entity, settings);
                                    beheerModel.ClubCloud_Functionarissen.AddOrUpdate(entity);
                                }
        ...
        */
        ...
        private void FunctionarisToEntity(sgt_alg_functionaris functionaris, ClubCloud_Functionaris entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = functionaris.statuscode.name;
            entity.Gewijzigd = DateTime.Now;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            contact contact = RetrieveEntity(service, new TargetRetrieveContact { EntityId = Id }) as contact;
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Gebruiker> GetGebruikers(string bondnummer, bool refresh, ClubCloud_Setting settings)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForGebruiker(string bondsnummer, ClubCloud_Gebruiker entity, bool refresh, ClubCloud_Setting settings)
        {
            return GetAddressesForGebruikerById(bondsnummer, entity.Id, refresh, settings);
        }
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForGebruikerById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            List<ClubCloud_Address> result = null;
            ...
            if (gebruiker != null)
            {
                ...
                {
                    result = beheerModel.ClubCloud_Addresses.Where(v => v.ParentId.Value == Id).ToList();
        ...
        */
        ...
        private void GebruikerToEntity(contact contact, ClubCloud_Gebruiker entity, ClubCloud_Setting settings)
        {
            ...
            ClubCloud_Vereniging vereniging = GetVerenigingById(entity.VerenigingId.Value, false, settings);
            entity.ClubCloud_Vereniging = vereniging;
            ...
            */
            ...
            entity.Actief = contact.statuscode.name;
            entity.Gewijzigd = DateTime.Now;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_lidmaatschap lidmaatschap = RetrieveEntity(service, new TargetRetrieveSgt_alg_lidmaatschap { EntityId = Id }) as sgt_alg_lidmaatschap;
        ...
        */
        ...
        private void LidmaatschapToEntity(sgt_alg_lidmaatschap lidmaatschap, ClubCloud_Lidmaatschap entity, string bondsnummer, ClubCloud_Setting settings)
        {
            ...
            if (lidmaatschap.sgt_soort_lidmaatschapid != null)
            {
                ...
                entity.LidmaatschapsoortId = soort.Id;//entity.sgt_soort_lidmaatschapid.Value;
            }
            ...
            entity.Actief = lidmaatschap.statuscode.name;
            entity.Gewijzigd = DateTime.Now;
        }
            ...
            if (lidmaatschapsoort == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_soort_lidmaatschap lidmaatschapsoort = RetrieveEntity(service, new TargetRetrieveSgt_alg_soort_lidmaatschap { EntityId = Id }) as sgt_alg_soort_lidmaatschap;
                            ...
                            while (moreRecords)
                            {
                                ConditionExpression condition = new ConditionExpression { AttributeName = "sgt_alg_soort_lidmaatschapid", Operator = ConditionOperator.Equal, Values = new object[1] { Id } };
                                FilterExpression expression = new FilterExpression { FilterOperator = LogicalOperator.And, Conditions = new ConditionExpression[1] { condition } };
        ...
        private void LidmaatschapsoortToEntity(sgt_alg_soort_lidmaatschap lidmaatschapsoort, ClubCloud_Lidmaatschapsoort entity, ClubCloud_Setting settings)
        {
            ...
            entity.Actief = lidmaatschapsoort.statuscode.name;
        }
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            sgt_alg_nationaliteit nationaliteit = RetrieveEntity(service, new TargetRetrieveSgt_alg_nationaliteit { EntityId = Id }) as sgt_alg_nationaliteit;
        ...
        private List<ClubCloud_Address> GetAddressesForRegio(string bondsnummer, ClubCloud_Regio entity, bool refresh, ClubCloud_Setting settings)
        {
            throw new NotImplementedException();
        }

        private List<ClubCloud_Address> GetAddressesForRegioById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            throw new NotImplementedException();
        }
        ...
        */
            ...
            if (entity == null || refresh)
            {
                ...
                if (settings != null && settings.Access && !string.IsNullOrWhiteSpace(settings.Password))
                {
                    ...
                    if (cc != null)
                    {
                        using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
                        {
                            account account = RetrieveEntity(service, new TargetRetrieveAccount { EntityId = Id }) as account;
                            ...
                            if (account != null && account.accountid.Value == Id)
                            {
                                ...
                                VerenigingToEntity(account, entity, bondsnummer, settings);
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForVereniging(string bondsnummer, ClubCloud_Vereniging entity, bool refresh, ClubCloud_Setting settings)
        {
            return GetAddressesForVerenigingById(bondsnummer, entity.Id, refresh, settings);
        }
        ...
        /// <param name="settings"></param>
        /// <returns></returns>
        private List<ClubCloud_Address> GetAddressesForVerenigingById(string bondsnummer, Guid Id, bool refresh, ClubCloud_Setting settings)
        {
            List<ClubCloud_Address> result = null;
        ...
        */
        ...
        private void VerenigingToEntity(account account, ClubCloud_Vereniging entity, string bondsnummer, ClubCloud_Setting settings)
        {
            ...
            {
                ClubCloud_District district = GetDistrictById(bondsnummer, account.sgt_districtid.Value, false, settings);
                entity.ClubCloud_District = district;
            ...
            {
                ClubCloud_Rechtsvorm rechtsvorm = GetRechtsvormById(bondsnummer, account.sgt_rechtsvormid.Value, false, settings);
            ...
            {
                ClubCloud_Accommodatie Accommodatie = GetAccommodatieById(bondsnummer, account.sgt_hoofdaccomodatieid.Value, false, settings);
                entity.ClubCloud_Accommodatie = Accommodatie;
            ...
            {
                ClubCloud_Address bezoek = GetAddressById(bondsnummer, account.address1_addressid.Value, false, settings);
                entity.ClubCloud_Address.Add(bezoek);
            }
            if (account.address2_addressid != null)
            {
                ClubCloud_Address post = GetAddressById(bondsnummer, account.address2_addressid.Value, false, settings);
                entity.ClubCloud_Address.Add(post);
            }

            if (account.parentaccountid != null)
            {
                ClubCloud_Regio regio = GetRegioById(bondsnummer, account.parentaccountid.Value, false, settings);
                entity.ClubCloud_Regio = regio;
            ...
            entity.TelefoonOverig = account.telephone1;
            ...
            entity.Actief = account.statuscode.name;
            entity.Gewijzigd = DateTime.Now;
        }
        ...
        */
        ...
        public List<ClubCloud_Address> GetAddressByGebruikerId(string bondsnummer, Guid verenigingId, Guid gebruikerId, bool refresh = false)
        {
            ...
            ValidateBondsnummer(ref bondsnummer, verenigingId);
            addressen = GetAddressesForGebruikerById(bondsnummer, gebruikerId, refresh, new ClubCloud_Setting { Id = int.Parse(bondsnummer), VerenigingId = verenigingId });
            return addressen;
        }
					...
					using (ClubCloud.KNLTB.ServIt.CrmService.CrmService service = CrmServices[settings.Id.ToString()])
					{
						...
						foreach (contact entity in entities)
						{
							...
							if (gebruiker == null)
							{
								...
								ContactToGebruiker(entity, vereniging.Id, gebruiker, bondsnummer);
