...
namespace ClubCloud.KNLTB.ServIt
{
	...
	[Serializable]
	public class sgt_toe_zwaarte : BusinessEntity
	{
		...
		[XmlElement(Order = 13)]
		public Key sgt_toe_zwaarteid
		{
			get
			{
				return this.sgt_toe_zwaarteidField;
			}
			set
			{
				this.sgt_toe_zwaarteidField = value;
				base.RaisePropertyChanged("sgt_toe_zwaarteid");
			}
		}
		[XmlElement(Order = 14)]
		...
		[XmlElement(Order = 17)]
		public Sgt_toe_zwaarteStateInfo statecode
		{
			get
			{
