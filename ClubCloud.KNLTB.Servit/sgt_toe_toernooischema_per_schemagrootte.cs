...
namespace ClubCloud.KNLTB.ServIt
{
	...
	[Serializable]
	public class sgt_toe_toernooischema_per_schemagrootte : BusinessEntity
	{
		...
		private Key sgt_toe_toernooischema_per_schemagrootteidField;
		private Lookup sgt_toernooischema_idField;
		private Sgt_toe_toernooischema_per_schemagrootteStateInfo statecodeField;
		...
		[XmlElement(Order = 10)]
		public Key sgt_toe_toernooischema_per_schemagrootteid
		{
			get
			{
				return this.sgt_toe_toernooischema_per_schemagrootteidField;
			}
			set
			{
				this.sgt_toe_toernooischema_per_schemagrootteidField = value;
				base.RaisePropertyChanged("sgt_toe_toernooischema_per_schemagrootteid");
			}
		}
		[XmlElement(Order = 11)]
		...
		[XmlElement(Order = 12)]
		public Sgt_toe_toernooischema_per_schemagrootteStateInfo statecode
		{
			get
			{
