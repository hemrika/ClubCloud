...
{
	[DataContract(Name="GetPloegenRequest", Namespace="http://schemas.datacontract.org/2004/07/KNLTB.ServIT2.Services")]
	[DebuggerStepThrough]
	[GeneratedCode("System.Runtime.Serialization", "4.0.0.0")]
	[Serializable]
	public class GetPloegenRequest : IExtensibleDataObject, INotifyPropertyChanged
	{
		[NonSerialized]
