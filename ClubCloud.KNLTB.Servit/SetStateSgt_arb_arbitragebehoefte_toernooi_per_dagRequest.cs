...
namespace ClubCloud.KNLTB.ServIt
{
	...
	public class SetStateSgt_arb_arbitragebehoefte_toernooi_per_dagRequest : Request
	{
		...
		private Sgt_arb_arbitragebehoefte_toernooi_per_dagState sgt_arb_arbitragebehoefte_toernooi_per_dagStateField;
		...
		[XmlElement(Order = 1)]
		public Sgt_arb_arbitragebehoefte_toernooi_per_dagState Sgt_arb_arbitragebehoefte_toernooi_per_dagState
		{
			get
			{
