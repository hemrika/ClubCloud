...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_verzendwijze : BusinessEntity
	{
		...
		private string sgt_alg_verzendwijze1Field;

		private Key sgt_alg_verzendwijzeidField;
		...
		private Sgt_alg_verzendwijzeStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_verzendwijze")] //, Order=7)]
		public string sgt_alg_verzendwijze1
		{
			get
			{
				return this.sgt_alg_verzendwijze1Field;
			}
			set
			{
				this.sgt_alg_verzendwijze1Field = value;
				base.RaisePropertyChanged("sgt_alg_verzendwijze1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_verzendwijzeid
		{
			get
			{
				return this.sgt_alg_verzendwijzeidField;
			}
			set
			{
				this.sgt_alg_verzendwijzeidField = value;
				base.RaisePropertyChanged("sgt_alg_verzendwijzeid");
			}
		}
		...
		public Sgt_alg_verzendwijzeStateInfo statecode
		{
			get
			{
