...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_type_ranglijst : BusinessEntity
	{
		...
		private string sgt_toe_ranglijst_typeField;

		private Key sgt_toe_type_ranglijstidField;

		private string sgt_verkorte_codeField;

		private Sgt_toe_type_ranglijstStateInfo statecodeField;
		...
		public string sgt_toe_ranglijst_type
		{
			get
			{
				return this.sgt_toe_ranglijst_typeField;
			}
			set
			{
				this.sgt_toe_ranglijst_typeField = value;
				base.RaisePropertyChanged("sgt_toe_ranglijst_type");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_toe_type_ranglijstid
		{
			get
			{
				return this.sgt_toe_type_ranglijstidField;
			}
			set
			{
				this.sgt_toe_type_ranglijstidField = value;
				base.RaisePropertyChanged("sgt_toe_type_ranglijstid");
			}
		}
		...
		public Sgt_toe_type_ranglijstStateInfo statecode
		{
			get
			{
