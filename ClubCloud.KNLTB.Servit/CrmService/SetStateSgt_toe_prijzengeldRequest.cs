...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class SetStateSgt_toe_prijzengeldRequest : Request
	{
		...
		private ClubCloud.KNLTB.ServIt.CrmService.Sgt_toe_prijzengeldState sgt_toe_prijzengeldStateField;
		...
		public ClubCloud.KNLTB.ServIt.CrmService.Sgt_toe_prijzengeldState Sgt_toe_prijzengeldState
		{
			get
			{
		...
		public SetStateSgt_toe_prijzengeldRequest()
		{
		}
	}
}