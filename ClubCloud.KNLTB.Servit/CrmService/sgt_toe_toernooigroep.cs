...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_toernooigroep : BusinessEntity
	{
		...
		private string sgt_toe_toernooigroep1Field;

		private Key sgt_toe_toernooigroepidField;

		private string sgt_verkorte_codeField;

		private Sgt_toe_toernooigroepStateInfo statecodeField;
		...
		[XmlElement("sgt_toe_toernooigroep")] //, Order=10)]
		public string sgt_toe_toernooigroep1
		{
			get
			{
				return this.sgt_toe_toernooigroep1Field;
			}
			set
			{
				this.sgt_toe_toernooigroep1Field = value;
				base.RaisePropertyChanged("sgt_toe_toernooigroep1");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_toe_toernooigroepid
		{
			get
			{
				return this.sgt_toe_toernooigroepidField;
			}
			set
			{
				this.sgt_toe_toernooigroepidField = value;
				base.RaisePropertyChanged("sgt_toe_toernooigroepid");
			}
		}
		...
		public Sgt_toe_toernooigroepStateInfo statecode
		{
			get
			{
