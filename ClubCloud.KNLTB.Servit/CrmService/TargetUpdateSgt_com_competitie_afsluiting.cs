...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_com_competitie_afsluiting : TargetUpdate
	{
		...
		public sgt_com_competitie_afsluiting Sgt_com_competitie_afsluiting
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_com_competitie_afsluiting");
			}
		}

		public TargetUpdateSgt_com_competitie_afsluiting()
		{
		}
	}
}