...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_alg_rol_pers_relatie : TargetUpdate
	{
		...
		public sgt_alg_rol_pers_relatie Sgt_alg_rol_pers_relatie
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_alg_rol_pers_relatie");
			}
		}

		public TargetUpdateSgt_alg_rol_pers_relatie()
		{
		}
	}
}