...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_pb_interface_logboek_import_xml : BusinessEntity
	{
		...
		private Key sgt_alg_pb_interface_logboek_import_xmlidField;
		...
		private Sgt_alg_pb_interface_logboek_import_xmlStateInfo statecodeField;
		...
		public Key sgt_alg_pb_interface_logboek_import_xmlid
		{
			get
			{
				return this.sgt_alg_pb_interface_logboek_import_xmlidField;
			}
			set
			{
				this.sgt_alg_pb_interface_logboek_import_xmlidField = value;
				base.RaisePropertyChanged("sgt_alg_pb_interface_logboek_import_xmlid");
			}
		}
		...
		public Sgt_alg_pb_interface_logboek_import_xmlStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_pb_interface_logboek_import_xml()
		{
		}
	}
}