...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_logboek_fact_export_facturen : BusinessEntity
	{
		...
		private Key sgt_alg_logboek_fact_export_facturenidField;
		...
		private Sgt_alg_logboek_fact_export_facturenStateInfo statecodeField;
		...
		public Key sgt_alg_logboek_fact_export_facturenid
		{
			get
			{
				return this.sgt_alg_logboek_fact_export_facturenidField;
			}
			set
			{
				this.sgt_alg_logboek_fact_export_facturenidField = value;
				base.RaisePropertyChanged("sgt_alg_logboek_fact_export_facturenid");
			}
		}
		...
		public Sgt_alg_logboek_fact_export_facturenStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_logboek_fact_export_facturen()
		{
		}
	}
}