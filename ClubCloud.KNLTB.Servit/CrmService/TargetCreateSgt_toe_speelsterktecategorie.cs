...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_toe_speelsterktecategorie : TargetCreate
	{
		...
		public sgt_toe_speelsterktecategorie Sgt_toe_speelsterktecategorie
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_toe_speelsterktecategorie");
			}
		}

		public TargetCreateSgt_toe_speelsterktecategorie()
		{
		}
	}
}