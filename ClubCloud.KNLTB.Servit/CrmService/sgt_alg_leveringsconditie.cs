...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_leveringsconditie : BusinessEntity
	{
		...
		private string sgt_alg_leveringsconditie1Field;

		private Key sgt_alg_leveringsconditieidField;
		...
		private Sgt_alg_leveringsconditieStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_leveringsconditie")] //, Order=7)]
		public string sgt_alg_leveringsconditie1
		{
			get
			{
				return this.sgt_alg_leveringsconditie1Field;
			}
			set
			{
				this.sgt_alg_leveringsconditie1Field = value;
				base.RaisePropertyChanged("sgt_alg_leveringsconditie1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_leveringsconditieid
		{
			get
			{
				return this.sgt_alg_leveringsconditieidField;
			}
			set
			{
				this.sgt_alg_leveringsconditieidField = value;
				base.RaisePropertyChanged("sgt_alg_leveringsconditieid");
			}
		}
		...
		public Sgt_alg_leveringsconditieStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_leveringsconditie()
		{
		}
	}
}