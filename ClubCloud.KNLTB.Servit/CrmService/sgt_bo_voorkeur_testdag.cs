...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_bo_voorkeur_testdag : BusinessEntity
	{
		...
		[XmlElement("sgt_bo_voorkeur_testdag")] //, Order=8)]
		public string sgt_bo_voorkeur_testdag1
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_bo_voorkeur_testdag1");
			}
		}
		...
		public Key sgt_bo_voorkeur_testdagid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_bo_voorkeur_testdagid");
			}
		}
		...
		public sgt_bo_voorkeur_testdag()
		{
		}
	}
}