...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sw_lookupviewtranslation : BusinessEntity
	{
		...
		private Sw_lookupviewtranslationStateInfo statecodeField;
		...
		private Key sw_lookupviewtranslationidField;
		...
		public Sw_lookupviewtranslationStateInfo statecode
		{
			get
			{
		...
		public Key sw_lookupviewtranslationid
		{
			get
			{
				return this.sw_lookupviewtranslationidField;
			}
			set
			{
				this.sw_lookupviewtranslationidField = value;
				base.RaisePropertyChanged("sw_lookupviewtranslationid");
			}
		}
		...
		public sw_lookupviewtranslation()
		{
		}
	}
}