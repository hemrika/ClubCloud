...
namespace ClubCloud.KNLTB.ServIt
{
	...
	[Serializable]
	public class sgt_alg_schorsing : BusinessEntity
	{
		...
		private string sgt_alg_schorsing1Field;
		private Key sgt_alg_schorsingidField;
		private string sgt_bondsnummerField;
		private CrmDateTime sgt_datum_tmField;
		private CrmDateTime sgt_datum_vanafField;
		private string sgt_reden_schorsingField;
		private Lookup sgt_speleridField;
		private Sgt_alg_schorsingStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_schorsing")]
		public string sgt_alg_schorsing1
		{
			get
			{
				return this.sgt_alg_schorsing1Field;
			}
			set
			{
				this.sgt_alg_schorsing1Field = value;
			}
		}
		public Key sgt_alg_schorsingid
		{
			get
			{
				return this.sgt_alg_schorsingidField;
			}
			set
			{
				this.sgt_alg_schorsingidField = value;
			}
		}
		...
		public string sgt_reden_schorsing
		{
			get
			{
				return this.sgt_reden_schorsingField;
			}
			set
			{
				this.sgt_reden_schorsingField = value;
			}
		}
		...
		public Sgt_alg_schorsingStateInfo statecode
		{
			get
			{
