...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_onderwerp_activiteit : BusinessEntity
	{
		...
		private Key sgt_alg_onderwerp_activiteitidField;
		...
		private Sgt_alg_onderwerp_activiteitStateInfo statecodeField;
		...
		public Key sgt_alg_onderwerp_activiteitid
		{
			get
			{
				return this.sgt_alg_onderwerp_activiteitidField;
			}
			set
			{
				this.sgt_alg_onderwerp_activiteitidField = value;
				base.RaisePropertyChanged("sgt_alg_onderwerp_activiteitid");
			}
		}
		...
		public Sgt_alg_onderwerp_activiteitStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_onderwerp_activiteit()
		{
		}
	}
}