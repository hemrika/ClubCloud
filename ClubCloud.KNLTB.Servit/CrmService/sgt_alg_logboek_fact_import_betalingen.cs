...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_logboek_fact_import_betalingen : BusinessEntity
	{
		...
		private Key sgt_alg_logboek_fact_import_betalingenidField;
		...
		private Sgt_alg_logboek_fact_import_betalingenStateInfo statecodeField;
		...
		public Key sgt_alg_logboek_fact_import_betalingenid
		{
			get
			{
				return this.sgt_alg_logboek_fact_import_betalingenidField;
			}
			set
			{
				this.sgt_alg_logboek_fact_import_betalingenidField = value;
				base.RaisePropertyChanged("sgt_alg_logboek_fact_import_betalingenid");
			}
		}
		...
		public Lookup sgt_logboek_facturatieid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_logboek_facturatieid");
			}
		}
		...
		public Sgt_alg_logboek_fact_import_betalingenStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_logboek_fact_import_betalingen()
		{
		}
	}
}