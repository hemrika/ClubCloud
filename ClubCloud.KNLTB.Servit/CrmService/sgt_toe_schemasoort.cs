...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_schemasoort : BusinessEntity
	{
		...
		private string sgt_toe_schemasoort1Field;

		private Key sgt_toe_schemasoortidField;

		private string sgt_verkorte_codeField;

		private string sgt_volgordenummerField;

		private Sgt_toe_schemasoortStateInfo statecodeField;
		...
		[XmlElement("sgt_toe_schemasoort")] //, Order=10)]
		public string sgt_toe_schemasoort1
		{
			get
			{
				return this.sgt_toe_schemasoort1Field;
			}
			set
			{
				this.sgt_toe_schemasoort1Field = value;
				base.RaisePropertyChanged("sgt_toe_schemasoort1");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_toe_schemasoortid
		{
			get
			{
				return this.sgt_toe_schemasoortidField;
			}
			set
			{
				this.sgt_toe_schemasoortidField = value;
				base.RaisePropertyChanged("sgt_toe_schemasoortid");
			}
		}
		...
		public Sgt_toe_schemasoortStateInfo statecode
		{
			get
			{
