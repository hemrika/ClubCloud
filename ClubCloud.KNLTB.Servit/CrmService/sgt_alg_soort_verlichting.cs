...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_soort_verlichting : BusinessEntity
	{
		...
		private string sgt_alg_soort_verlichting1Field;

		private Key sgt_alg_soort_verlichtingidField;
		...
		private Sgt_alg_soort_verlichtingStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_soort_verlichting")] //, Order=7)]
		public string sgt_alg_soort_verlichting1
		{
			get
			{
				return this.sgt_alg_soort_verlichting1Field;
			}
			set
			{
				this.sgt_alg_soort_verlichting1Field = value;
				base.RaisePropertyChanged("sgt_alg_soort_verlichting1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_soort_verlichtingid
		{
			get
			{
				return this.sgt_alg_soort_verlichtingidField;
			}
			set
			{
				this.sgt_alg_soort_verlichtingidField = value;
				base.RaisePropertyChanged("sgt_alg_soort_verlichtingid");
			}
		}
		...
		public Sgt_alg_soort_verlichtingStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_soort_verlichting()
		{
		}
	}
}