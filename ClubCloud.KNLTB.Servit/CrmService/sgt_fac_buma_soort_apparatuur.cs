...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_fac_buma_soort_apparatuur : BusinessEntity
	{
		...
		private Key sgt_fac_buma_soort_apparatuuridField;

		private string sgt_fac_soort_apparatuurField;
		...
		private Sgt_fac_buma_soort_apparatuurStateInfo statecodeField;
		...
		public Key sgt_fac_buma_soort_apparatuurid
		{
			get
			{
				return this.sgt_fac_buma_soort_apparatuuridField;
			}
			set
			{
				this.sgt_fac_buma_soort_apparatuuridField = value;
				base.RaisePropertyChanged("sgt_fac_buma_soort_apparatuurid");
			}
		}

		[XmlElement] //[XmlElement(Order=9)]
		public string sgt_fac_soort_apparatuur
		{
			get
			{
				return this.sgt_fac_soort_apparatuurField;
			}
			set
			{
				this.sgt_fac_soort_apparatuurField = value;
				base.RaisePropertyChanged("sgt_fac_soort_apparatuur");
			}
		}
		...
		public Sgt_fac_buma_soort_apparatuurStateInfo statecode
		{
			get
			{
		...
		public sgt_fac_buma_soort_apparatuur()
		{
		}
	}
}