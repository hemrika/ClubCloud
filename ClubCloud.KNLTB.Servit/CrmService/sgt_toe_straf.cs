...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_straf : BusinessEntity
	{
		...
		private string sgt_toe_straf1Field;

		private Key sgt_toe_strafidField;

		private string sgt_verkorte_codeField;

		private Sgt_toe_strafStateInfo statecodeField;
		...
		[XmlElement("sgt_toe_straf")] //, Order=10)]
		public string sgt_toe_straf1
		{
			get
			{
				return this.sgt_toe_straf1Field;
			}
			set
			{
				this.sgt_toe_straf1Field = value;
				base.RaisePropertyChanged("sgt_toe_straf1");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_toe_strafid
		{
			get
			{
				return this.sgt_toe_strafidField;
			}
			set
			{
				this.sgt_toe_strafidField = value;
				base.RaisePropertyChanged("sgt_toe_strafid");
			}
		}
		...
		public Sgt_toe_strafStateInfo statecode
		{
			get
			{
