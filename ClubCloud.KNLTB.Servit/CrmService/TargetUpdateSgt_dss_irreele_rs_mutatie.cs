...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_dss_irreele_rs_mutatie : TargetUpdate
	{
		...
		public sgt_dss_irreele_rs_mutatie Sgt_dss_irreele_rs_mutatie
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_dss_irreele_rs_mutatie");
			}
		}

		public TargetUpdateSgt_dss_irreele_rs_mutatie()
		{
		}
	}
}