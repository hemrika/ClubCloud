...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_toe_reden_afwijzing_toernooi : TargetUpdate
	{
		...
		public sgt_toe_reden_afwijzing_toernooi Sgt_toe_reden_afwijzing_toernooi
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_toe_reden_afwijzing_toernooi");
			}
		}

		public TargetUpdateSgt_toe_reden_afwijzing_toernooi()
		{
		}
	}
}