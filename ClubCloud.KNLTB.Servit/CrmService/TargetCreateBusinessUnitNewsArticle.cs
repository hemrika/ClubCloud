...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateBusinessUnitNewsArticle : TargetCreate
	{
		...
		public businessunitnewsarticle BusinessUnitNewsArticle
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("BusinessUnitNewsArticle");
			}
		}

		public TargetCreateBusinessUnitNewsArticle()
		{
		}
	}
}