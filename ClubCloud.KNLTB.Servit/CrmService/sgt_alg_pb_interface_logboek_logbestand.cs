...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_pb_interface_logboek_logbestand : BusinessEntity
	{
		...
		private Key sgt_alg_pb_interface_logboek_logbestandidField;
		...
		private Sgt_alg_pb_interface_logboek_logbestandStateInfo statecodeField;
		...
		public Key sgt_alg_pb_interface_logboek_logbestandid
		{
			get
			{
				return this.sgt_alg_pb_interface_logboek_logbestandidField;
			}
			set
			{
				this.sgt_alg_pb_interface_logboek_logbestandidField = value;
				base.RaisePropertyChanged("sgt_alg_pb_interface_logboek_logbestandid");
			}
		}
		...
		public Sgt_alg_pb_interface_logboek_logbestandStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_pb_interface_logboek_logbestand()
		{
		}
	}
}