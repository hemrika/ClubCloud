...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_pastype : BusinessEntity
	{
		...
		private string sgt_alg_pastype1Field;

		private Key sgt_alg_pastypeidField;
		...
		private Sgt_alg_pastypeStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_pastype")] //, Order=7)]
		public string sgt_alg_pastype1
		{
			get
			{
				return this.sgt_alg_pastype1Field;
			}
			set
			{
				this.sgt_alg_pastype1Field = value;
				base.RaisePropertyChanged("sgt_alg_pastype1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_pastypeid
		{
			get
			{
				return this.sgt_alg_pastypeidField;
			}
			set
			{
				this.sgt_alg_pastypeidField = value;
				base.RaisePropertyChanged("sgt_alg_pastypeid");
			}
		}
		...
		public Sgt_alg_pastypeStateInfo statecode
		{
			get
			{
