...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_toe_dynamische_velden_per_toernooi : TargetCreate
	{
		...
		public sgt_toe_dynamische_velden_per_toernooi Sgt_toe_dynamische_velden_per_toernooi
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_toe_dynamische_velden_per_toernooi");
			}
		}

		public TargetCreateSgt_toe_dynamische_velden_per_toernooi()
		{
		}
	}
}