...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_ranglijst_deelgetal : BusinessEntity
	{
		...
		[XmlElement("sgt_toe_ranglijst_deelgetal")] //, Order=9)]
		public string sgt_toe_ranglijst_deelgetal1
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_toe_ranglijst_deelgetal1");
			}
		}
		...
		public Key sgt_toe_ranglijst_deelgetalid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_toe_ranglijst_deelgetalid");
			}
		}
		...
		public sgt_toe_ranglijst_deelgetal()
		{
		}
	}
}