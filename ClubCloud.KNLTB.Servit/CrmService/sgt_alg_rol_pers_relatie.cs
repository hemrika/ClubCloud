...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_rol_pers_relatie : BusinessEntity
	{
		...
		private string sgt_alg_rolField;

		private Key sgt_alg_rol_pers_relatieidField;
		...
		private Sgt_alg_rol_pers_relatieStateInfo statecodeField;
		...
		public string sgt_alg_rol
		{
			get
			{
				return this.sgt_alg_rolField;
			}
			set
			{
				this.sgt_alg_rolField = value;
				base.RaisePropertyChanged("sgt_alg_rol");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_rol_pers_relatieid
		{
			get
			{
				return this.sgt_alg_rol_pers_relatieidField;
			}
			set
			{
				this.sgt_alg_rol_pers_relatieidField = value;
				base.RaisePropertyChanged("sgt_alg_rol_pers_relatieid");
			}
		}
		...
		public Sgt_alg_rol_pers_relatieStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_rol_pers_relatie()
		{
		}
	}
}