...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_logboek_ledenpas_retour : BusinessEntity
	{
		...
		private Key sgt_alg_logboek_ledenpas_retouridField;
		...
		private Sgt_alg_logboek_ledenpas_retourStateInfo statecodeField;
		...
		public Key sgt_alg_logboek_ledenpas_retourid
		{
			get
			{
				return this.sgt_alg_logboek_ledenpas_retouridField;
			}
			set
			{
				this.sgt_alg_logboek_ledenpas_retouridField = value;
				base.RaisePropertyChanged("sgt_alg_logboek_ledenpas_retourid");
			}
		}
		...
		public Sgt_alg_logboek_ledenpas_retourStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_logboek_ledenpas_retour()
		{
		}
	}
}