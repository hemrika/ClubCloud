...
namespace ClubCloud.KNLTB.ServIt
{
	...
	[Serializable]
	public class sgt_dss_irreele_rs_logboek : BusinessEntity
	{
		...
		private Key sgt_dss_irreele_rs_logboekidField;
		private string sgt_dss_omschrijvingField;
		private Picklist sgt_statusField;
		private string sgt_volgnummer_irs_logboekField;
		private Sgt_dss_Irreele_rs_logboekStateInfo statecodeField;
		...
		[XmlElement(Order = 8)]
		public Key sgt_dss_irreele_rs_logboekid
		{
			get
			{
				return this.sgt_dss_irreele_rs_logboekidField;
			}
			set
			{
				this.sgt_dss_irreele_rs_logboekidField = value;
				base.RaisePropertyChanged("sgt_dss_irreele_rs_logboekid");
			}
		}
		[XmlElement(Order = 9)]
		...
		[XmlElement(Order = 12)]
		public Sgt_dss_Irreele_rs_logboekStateInfo statecode
		{
			get
			{
