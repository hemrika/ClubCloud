...
<div class="first dark forms">
    ...
    <asp:UpdatePanel ID="udp_aanmelden" runat="server" UpdateMode="Always" RenderMode="Block" ChildrenAsTriggers="true">
        <ContentTemplate>
            ...
            <asp:CheckBoxList ID="cbl_templates" runat="server"></asp:CheckBoxList>
        </ContentTemplate>
    </asp:UpdatePanel>
</div>
