...
<asp:Content ID="Content1" ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<div class="inner light">
      <div class="aligncenter">
        <h1 id="pageTitle" class="lined">Mijn ClubCloud Machtiging</h1>
        <p class="description">Instellingen voor het gebruiken van machtingen.</p>
        </div>
    </div>
    <div class="inner dark">
      <div class="services">
        ...
        <i class="icon-vcard special"></i>
          <div class="info">
            <h3 class="lined">Machtiging instellingen</h3>
            <p>instellingen
            </p>
            <p></p>
          </div>
        ...
        <i class="icon-menu special"></i>
          <div class="info">
            <h3 class="lined">Bank gegevens</h3>
            <p>instellingen</p>
            <p></p>
          </div>
        </div>  
