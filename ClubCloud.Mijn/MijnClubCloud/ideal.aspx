...
<asp:Content ID="Content1" ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<div class="inner light">
      <div class="aligncenter">
        <h1 id="pageTitle" class="lined">Mijn ClubCloud iDeal</h1>
        <p class="description">Instellingen voor het gebruiken van iDeal.</p>
        </div>
    </div>
    <div class="inner dark">
      <div class="services">
        ...
        <i class="icon-vcard special"></i>
          <div class="info">
            <h3 class="lined">iDeal instellingen</h3>
            <p>instellingen
            </p>
            <p></p>
          </div>
