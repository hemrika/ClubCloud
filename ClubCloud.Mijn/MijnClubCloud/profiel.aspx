...
<asp:Content ID="Content1" ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<div class="inner light">
      <div class="aligncenter">
        ...
        <p class="description">Uw ClubCloud profiel gegevens worden samengesteld 
		uit uw eigen gegevens en informatie vanuit de KNLTB.</p>
        </div>
    </div>
      ...
      <div class="services">
        ...
        <i class="icon-vcard special"></i>
          <div class="info">
            ...
            <p>Dit zijn uw eigen gegevens. Indien uw vereniging ClubCloud 
			gebruikt, worden deze gegevens automatisch overgenomen in de 
			administratie.
            </p>
            <p></p>
          </div>
        ...
        <i class="icon-menu special"></i>
          <div class="info">
            ...
            <p>Dit zijn uw gegevens vanuit de KNLTB. Deze gegevens kunt u helaas 
			niet wijzigen.</p>
            <p></p>
          </div>
        </div>  
        <div class="clear"></div>
        <p>Via <a href="instellingen.aspx" title="Instellingen">Instellingen</a> 
		kunt aangeven welke gegevens andere ClubCloud gebruikers kunnen zien.</p>
	</div>    
   	<div class="clear"></div>
    </div>
</asp:Content>
