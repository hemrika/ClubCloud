...
<%@ Register TagPrefix="SharePoint" Namespace="Microsoft.SharePoint.WebControls" Assembly="Microsoft.SharePoint, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Register TagPrefix="Utilities" Namespace="Microsoft.SharePoint.Utilities" Assembly="Microsoft.SharePoint, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MijnCompetitieUserControl.ascx.cs" Inherits="ClubCloud.Mijn.ControlTemplates.MijnCompetitieUserControl" %>
<asp:UpdatePanel ID="udp_competitie" runat="server">
    <contenttemplate>
        <asp:Timer runat="server" ID="tmr_loader_competitie" OnTick="tmr_loader_competitie_Tick" interval="50" />
        ...
        <fieldset>
        <asp:panel runat="server" ID="pnl_competitie" GroupingText="Competitie :">
            </asp:panel>
            </fieldset>
        </contenttemplate>
    <triggers>
             <asp:AsyncPostBackTrigger ControlID="tmr_loader_competitie" EventName="Tick" />
    </triggers>
</asp:UpdatePanel>
<asp:UpdateProgress ID="udp_competitie_progress" runat="server" AssociatedUpdatePanelID="udp_competitie">
    <progresstemplate>
