...
namespace ClubCloud.Model
{
    ...
    public partial class ClubCloud_Land : INotifyPropertyChanged, IDataErrorInfo, INotifyDataErrorInfo, ICloneable
    {
    ...
    public class ClubCloud_Land_Mapping : EntityTypeConfiguration<ClubCloud_Land>
    {
    	public ClubCloud_Land_Mapping() 
    	{
    		//System.Guid
    		HasKey(m => m.Id);
    	}
