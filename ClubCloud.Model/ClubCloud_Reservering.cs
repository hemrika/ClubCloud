...
namespace ClubCloud.Model
{
    ...
    public partial class ClubCloud_Reservering : INotifyPropertyChanged, IDataErrorInfo, INotifyDataErrorInfo, ICloneable
    {
    ...
    public class ClubCloud_Reservering_Mapping : EntityTypeConfiguration<ClubCloud_Reservering>
    {
    	public ClubCloud_Reservering_Mapping() 
    	{
    		//System.Guid
    		HasKey(m => m.Id);
    	}
