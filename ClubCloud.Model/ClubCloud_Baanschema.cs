...
namespace ClubCloud.Model
{
    ...
    [DataContract]
    [TypeDescriptionProvider(typeof(ClubCloud_Baanschema_TypeDescriptionProvider))]
    public partial class ClubCloud_Baanschema : INotifyPropertyChanged, IDataErrorInfo, INotifyDataErrorInfo, ICloneable
    {
    	...
    	[IgnoreDataMember]
    	private MonthSoort _maandBegin;
    
    	[DataMember]
    	public MonthSoort MaandEinde 
    	{ 
    	...
    	[IgnoreDataMember]
    	private MonthSoort _maandEinde;
    
    	[DataMember]
    	public DaysSoort Dag 
    	{ 
    		get { return _dag; } 
    ...
    public class ClubCloud_Baanschema_Mapping : EntityTypeConfiguration<ClubCloud_Baanschema>
    {
    	public ClubCloud_Baanschema_Mapping() 
    	{
    		//System.Guid
    		HasKey(m => m.Id);
    	}
    ...
    public class ClubCloud_Baanschema_TypeDescriptionProvider : TypeDescriptionProvider
    {
    	private ICustomTypeDescriptor td;
    
    	public ClubCloud_Baanschema_TypeDescriptionProvider() : this(TypeDescriptor.GetProvider(typeof(ClubCloud_Baanschema))) {}
    
    	public ClubCloud_Baanschema_TypeDescriptionProvider(TypeDescriptionProvider parent) : base(parent) {}
    	...
    	public override ICustomTypeDescriptor GetTypeDescriptor(Type objectType, object instance)
    	{
    		if (td == null)
    		{
    			...
    			td = new ClubCloud_Baanschema_CustomTypeDescriptor(td);
    		}
    ...
    public class ClubCloud_Baanschema_CustomTypeDescriptor : CustomTypeDescriptor
    {       
    	public ClubCloud_Baanschema_CustomTypeDescriptor(ICustomTypeDescriptor parent) : base(parent) {}
    	...
    	public override PropertyDescriptorCollection GetProperties()
    	{
    		...
    		//ClubCloud_Baan
    		PropertyDescriptor ClubCloud_Baan_Columns = cols["ClubCloud_Baan"];
    		PropertyDescriptorCollection ClubCloud_Baan_Children = ClubCloud_Baan_Columns.GetChildProperties();
    
    		PropertyDescriptor ClubCloud_Baan_Id = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Id"],"ClubCloud_Baan_Id");
    		extended.Add(ClubCloud_Baan_Id);
    
    		PropertyDescriptor ClubCloud_Baan_Naam = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Naam"],"ClubCloud_Baan_Naam");
    		extended.Add(ClubCloud_Baan_Naam);
    
    		PropertyDescriptor ClubCloud_Baan_Nummer = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Nummer"],"ClubCloud_Baan_Nummer");
    		extended.Add(ClubCloud_Baan_Nummer);
    
    		PropertyDescriptor ClubCloud_Baan_BaanblokId = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["BaanblokId"],"ClubCloud_Baan_BaanblokId");
    		extended.Add(ClubCloud_Baan_BaanblokId);
    
    		PropertyDescriptor ClubCloud_Baan_AccommodatieId = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["AccommodatieId"],"ClubCloud_Baan_AccommodatieId");
    		extended.Add(ClubCloud_Baan_AccommodatieId);
    
    		PropertyDescriptor ClubCloud_Baan_Status = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Status"],"ClubCloud_Baan_Status");
    		extended.Add(ClubCloud_Baan_Status);
    
    		PropertyDescriptor ClubCloud_Baan_Keuring = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Keuring"],"ClubCloud_Baan_Keuring");
    		extended.Add(ClubCloud_Baan_Keuring);
    
    		PropertyDescriptor ClubCloud_Baan_Actief = new BeheerPropertyDescriptor(ClubCloud_Baan_Columns,ClubCloud_Baan_Children["Actief"],"ClubCloud_Baan_Actief");
    		extended.Add(ClubCloud_Baan_Actief);
