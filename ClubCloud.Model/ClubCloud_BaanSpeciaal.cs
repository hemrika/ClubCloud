...
namespace ClubCloud.Model
{
    ...
    public partial class ClubCloud_BaanSpeciaal : INotifyPropertyChanged, IDataErrorInfo, INotifyDataErrorInfo, ICloneable
    {
