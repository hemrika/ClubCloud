	...
	public class sgt_com_inschrijfbijdrage : BusinessEntity
	{
		...
		public CrmMoney sgt_bedrag_ib
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_bedrag_ib");
			}
		}
		...
		public CrmMoney sgt_bedrag_ib_base
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_bedrag_ib_base");
			}
		}
		...
		public string sgt_com_code
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_com_code");
			}
		}
		...
		public Key sgt_com_inschrijfbijdrageid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_com_inschrijfbijdrageid");
			}
		}
		...
		public sgt_com_inschrijfbijdrage()
		{
		}
	}
}