...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_toplaag : BusinessEntity
	{
		...
		private string sgt_alg_toplaag1Field;

		private Key sgt_alg_toplaagidField;
		...
		private Sgt_alg_toplaagStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_toplaag")] //, Order=7)]
		public string sgt_alg_toplaag1
		{
			get
			{
				return this.sgt_alg_toplaag1Field;
			}
			set
			{
				this.sgt_alg_toplaag1Field = value;
				base.RaisePropertyChanged("sgt_alg_toplaag1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_toplaagid
		{
			get
			{
				return this.sgt_alg_toplaagidField;
			}
			set
			{
				this.sgt_alg_toplaagidField = value;
				base.RaisePropertyChanged("sgt_alg_toplaagid");
			}
		}
		...
		public Sgt_alg_toplaagStateInfo statecode
		{
			get
			{
