...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class SetStateInvoiceRequest : Request
	{
		...
		private ClubCloud.KNLTB.ServIt.CrmService.InvoiceState invoiceStateField;
		...
		public ClubCloud.KNLTB.ServIt.CrmService.InvoiceState InvoiceState
		{
			get
			{
