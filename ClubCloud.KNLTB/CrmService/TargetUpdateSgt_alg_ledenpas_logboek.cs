...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_alg_ledenpas_logboek : TargetUpdate
	{
		...
		public sgt_alg_ledenpas_logboek Sgt_alg_ledenpas_logboek
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_alg_ledenpas_logboek");
			}
		}

		public TargetUpdateSgt_alg_ledenpas_logboek()
		{
		}
	}
}