...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_pb_mutatie_toernooiuitslag_set : BusinessEntity
	{
		...
		private Lookup sgt_pb_to_verwijzing_partij_idField;
		...
		private string sgt_thuis_gamesField;

		private Key sgt_toe_pb_mutatie_toernooiuitslag_setidField;

		private string sgt_toe_volgnummerField;

		private string sgt_uit_gamesField;

		private Sgt_toe_pb_mutatie_toernooiuitslag_setStateInfo statecodeField;
		...
		public Lookup sgt_pb_to_verwijzing_partij_id
		{
			get
			{
				return this.sgt_pb_to_verwijzing_partij_idField;
			}
			set
			{
				this.sgt_pb_to_verwijzing_partij_idField = value;
				base.RaisePropertyChanged("sgt_pb_to_verwijzing_partij_id");
			}
		}
		...
		public string sgt_thuis_games
		{
			get
			{
				return this.sgt_thuis_gamesField;
			}
			set
			{
				this.sgt_thuis_gamesField = value;
				base.RaisePropertyChanged("sgt_thuis_games");
			}
		}

		[XmlElement] //[XmlElement(Order=17)]
		public Key sgt_toe_pb_mutatie_toernooiuitslag_setid
		{
			get
			{
				return this.sgt_toe_pb_mutatie_toernooiuitslag_setidField;
			}
			set
			{
				this.sgt_toe_pb_mutatie_toernooiuitslag_setidField = value;
				base.RaisePropertyChanged("sgt_toe_pb_mutatie_toernooiuitslag_setid");
			}
		}
		...
		public string sgt_uit_games
		{
			get
			{
				return this.sgt_uit_gamesField;
			}
			set
			{
				this.sgt_uit_gamesField = value;
				base.RaisePropertyChanged("sgt_uit_games");
			}
		}

		[XmlElement] //[XmlElement(Order=20)]
		public Sgt_toe_pb_mutatie_toernooiuitslag_setStateInfo statecode
		{
			get
			{
		...
		public sgt_toe_pb_mutatie_toernooiuitslag_set()
		{
		}
	}
}