...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_zwaarte_op_toernooiniveau : BusinessEntity
	{
		...
		private Key sgt_toe_zwaarte_op_toernooiniveauidField;

		private string sgt_verkorte_codeField;

		private string sgt_zwaarteField;

		private Sgt_toe_zwaarte_op_toernooiniveauStateInfo statecodeField;
		...
		public Key sgt_toe_zwaarte_op_toernooiniveauid
		{
			get
			{
				return this.sgt_toe_zwaarte_op_toernooiniveauidField;
			}
			set
			{
				this.sgt_toe_zwaarte_op_toernooiniveauidField = value;
				base.RaisePropertyChanged("sgt_toe_zwaarte_op_toernooiniveauid");
			}
		}
		...
		public Sgt_toe_zwaarte_op_toernooiniveauStateInfo statecode
		{
			get
			{
		...
		public sgt_toe_zwaarte_op_toernooiniveau()
		{
		}
	}
}