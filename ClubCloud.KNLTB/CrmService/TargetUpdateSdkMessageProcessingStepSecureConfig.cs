...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSdkMessageProcessingStepSecureConfig : TargetUpdate
	{
		...
		public sdkmessageprocessingstepsecureconfig SdkMessageProcessingStepSecureConfig
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("SdkMessageProcessingStepSecureConfig");
			}
		}

		public TargetUpdateSdkMessageProcessingStepSecureConfig()
		{
		}
	}
}