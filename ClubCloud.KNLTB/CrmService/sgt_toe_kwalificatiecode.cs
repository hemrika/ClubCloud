...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_kwalificatiecode : BusinessEntity
	{
		...
		private string sgt_toe_kwalificatiecode1Field;

		private Key sgt_toe_kwalificatiecodeidField;

		private string sgt_verkorte_codeField;

		private Sgt_toe_kwalificatiecodeStateInfo statecodeField;
		...
		[XmlElement("sgt_toe_kwalificatiecode")] //, Order=10)]
		public string sgt_toe_kwalificatiecode1
		{
			get
			{
				return this.sgt_toe_kwalificatiecode1Field;
			}
			set
			{
				this.sgt_toe_kwalificatiecode1Field = value;
				base.RaisePropertyChanged("sgt_toe_kwalificatiecode1");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_toe_kwalificatiecodeid
		{
			get
			{
				return this.sgt_toe_kwalificatiecodeidField;
			}
			set
			{
				this.sgt_toe_kwalificatiecodeidField = value;
				base.RaisePropertyChanged("sgt_toe_kwalificatiecodeid");
			}
		}
		...
		public Sgt_toe_kwalificatiecodeStateInfo statecode
		{
			get
			{
		...
		public sgt_toe_kwalificatiecode()
		{
		}
	}
}