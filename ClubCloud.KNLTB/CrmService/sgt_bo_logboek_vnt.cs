...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_bo_logboek_vnt : BusinessEntity
	{
		...
		private Key sgt_bo_logboek_vntidField;
		...
		private Sgt_bo_logboek_VNTStateInfo statecodeField;
		...
		public Key sgt_bo_logboek_vntid
		{
			get
			{
				return this.sgt_bo_logboek_vntidField;
			}
			set
			{
				this.sgt_bo_logboek_vntidField = value;
				base.RaisePropertyChanged("sgt_bo_logboek_vntid");
			}
		}
		...
		public Sgt_bo_logboek_VNTStateInfo statecode
		{
			get
			{
