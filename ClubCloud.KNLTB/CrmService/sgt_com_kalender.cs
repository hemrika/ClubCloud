...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_com_kalender : BusinessEntity
	{
		...
		private Key sgt_com_kalenderidField;

		private string sgt_meervoudsnaamField;

		private string sgt_moss_urlField;
		...
		private Sgt_com_kalenderStateInfo statecodeField;
		...
		public Key sgt_com_kalenderid
		{
			get
			{
				return this.sgt_com_kalenderidField;
			}
			set
			{
				this.sgt_com_kalenderidField = value;
				base.RaisePropertyChanged("sgt_com_kalenderid");
			}
		}
		...
		public string sgt_moss_url
		{
			get
			{
				return this.sgt_moss_urlField;
			}
			set
			{
				this.sgt_moss_urlField = value;
				base.RaisePropertyChanged("sgt_moss_url");
			}
		}
		...
		public Sgt_com_kalenderStateInfo statecode
		{
			get
			{
