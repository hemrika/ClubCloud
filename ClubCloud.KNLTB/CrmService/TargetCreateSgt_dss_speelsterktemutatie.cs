...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_dss_speelsterktemutatie : TargetCreate
	{
		...
		public sgt_dss_speelsterktemutatie Sgt_dss_speelsterktemutatie
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_dss_speelsterktemutatie");
			}
		}

		public TargetCreateSgt_dss_speelsterktemutatie()
		{
		}
	}
}