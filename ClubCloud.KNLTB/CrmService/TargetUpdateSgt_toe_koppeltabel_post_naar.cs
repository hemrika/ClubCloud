...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_toe_koppeltabel_post_naar : TargetUpdate
	{
		...
		public sgt_toe_koppeltabel_post_naar Sgt_toe_koppeltabel_post_naar
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_toe_koppeltabel_post_naar");
			}
		}

		public TargetUpdateSgt_toe_koppeltabel_post_naar()
		{
		}
	}
}