...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_toe_inschrijfmethode_per_toernooisoort : TargetUpdate
	{
		...
		public sgt_toe_inschrijfmethode_per_toernooisoort Sgt_toe_inschrijfmethode_per_toernooisoort
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_toe_inschrijfmethode_per_toernooisoort");
			}
		}

		public TargetUpdateSgt_toe_inschrijfmethode_per_toernooisoort()
		{
		}
	}
}