...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_pb_interface_logboek_leden_import : BusinessEntity
	{
		...
		private Key sgt_alg_pb_interface_logboek_leden_importidField;
		...
		private Sgt_alg_pb_interface_logboek_leden_importStateInfo statecodeField;
		...
		public Key sgt_alg_pb_interface_logboek_leden_importid
		{
			get
			{
				return this.sgt_alg_pb_interface_logboek_leden_importidField;
			}
			set
			{
				this.sgt_alg_pb_interface_logboek_leden_importidField = value;
				base.RaisePropertyChanged("sgt_alg_pb_interface_logboek_leden_importid");
			}
		}
		...
		public Sgt_alg_pb_interface_logboek_leden_importStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_pb_interface_logboek_leden_import()
		{
		}
	}
}