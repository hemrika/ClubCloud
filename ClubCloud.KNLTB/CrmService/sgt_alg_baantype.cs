...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_baantype : BusinessEntity
	{
		...
		private string sgt_alg_baantype1Field;

		private Key sgt_alg_baantypeidField;
		...
		private Sgt_alg_baantypeStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_baantype")] //, Order=7)]
		public string sgt_alg_baantype1
		{
			get
			{
				return this.sgt_alg_baantype1Field;
			}
			set
			{
				this.sgt_alg_baantype1Field = value;
				base.RaisePropertyChanged("sgt_alg_baantype1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_baantypeid
		{
			get
			{
				return this.sgt_alg_baantypeidField;
			}
			set
			{
				this.sgt_alg_baantypeidField = value;
				base.RaisePropertyChanged("sgt_alg_baantypeid");
			}
		}
		...
		public Sgt_alg_baantypeStateInfo statecode
		{
			get
			{
