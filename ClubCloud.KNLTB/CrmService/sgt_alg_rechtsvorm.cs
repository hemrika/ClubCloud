...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_rechtsvorm : BusinessEntity
	{
		...
		private string sgt_alg_rechtsvorm1Field;

		private Key sgt_alg_rechtsvormidField;
		...
		private Sgt_alg_rechtsvormStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_rechtsvorm")] //, Order=7)]
		public string sgt_alg_rechtsvorm1
		{
			get
			{
				return this.sgt_alg_rechtsvorm1Field;
			}
			set
			{
				this.sgt_alg_rechtsvorm1Field = value;
				base.RaisePropertyChanged("sgt_alg_rechtsvorm1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_rechtsvormid
		{
			get
			{
				return this.sgt_alg_rechtsvormidField;
			}
			set
			{
				this.sgt_alg_rechtsvormidField = value;
				base.RaisePropertyChanged("sgt_alg_rechtsvormid");
			}
		}
		...
		public Sgt_alg_rechtsvormStateInfo statecode
		{
			get
			{
