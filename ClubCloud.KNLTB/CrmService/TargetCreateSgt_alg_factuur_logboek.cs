...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_alg_factuur_logboek : TargetCreate
	{
		...
		public sgt_alg_factuur_logboek Sgt_alg_factuur_logboek
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_alg_factuur_logboek");
			}
		}

		public TargetCreateSgt_alg_factuur_logboek()
		{
		}
	}
}