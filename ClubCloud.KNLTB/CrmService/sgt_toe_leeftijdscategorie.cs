...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_toe_leeftijdscategorie : BusinessEntity
	{
		...
		[XmlElement("sgt_toe_leeftijdscategorie")] //, Order=11)]
		public string sgt_toe_leeftijdscategorie1
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_toe_leeftijdscategorie1");
			}
		}
		...
		public Key sgt_toe_leeftijdscategorieid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_toe_leeftijdscategorieid");
			}
		}
		...
		public sgt_toe_leeftijdscategorie()
		{
		}
	}
}