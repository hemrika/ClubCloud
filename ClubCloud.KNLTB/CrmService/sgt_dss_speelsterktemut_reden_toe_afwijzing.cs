	...
	public class sgt_dss_speelsterktemut_reden_toe_afwijzing : BusinessEntity
	{
		...
		public string sgt_dss_reden_toe_afwijzing
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_dss_reden_toe_afwijzing");
			}
		}
		...
		public Key sgt_dss_speelsterktemut_reden_toe_afwijzingid
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_dss_speelsterktemut_reden_toe_afwijzingid");
			}
		}
		...
		public string sgt_sgt_beschrijving
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("sgt_sgt_beschrijving");
			}
		}
		...
		public sgt_dss_speelsterktemut_reden_toe_afwijzing()
		{
		}
	}
}