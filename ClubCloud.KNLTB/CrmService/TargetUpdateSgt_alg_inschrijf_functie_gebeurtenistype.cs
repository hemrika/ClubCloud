...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateSgt_alg_inschrijf_functie_gebeurtenistype : TargetUpdate
	{
		...
		public sgt_alg_inschrijf_functie_gebeurtenistype Sgt_alg_inschrijf_functie_gebeurtenistype
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_alg_inschrijf_functie_gebeurtenistype");
			}
		}

		public TargetUpdateSgt_alg_inschrijf_functie_gebeurtenistype()
		{
		}
	}
}