...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetUpdateFixedMonthlyFiscalCalendar : TargetUpdate
	{
		...
		public fixedmonthlyfiscalcalendar FixedMonthlyFiscalCalendar
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("FixedMonthlyFiscalCalendar");
			}
		}

		public TargetUpdateFixedMonthlyFiscalCalendar()
		{
		}
	}
}