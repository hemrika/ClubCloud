...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_flexibel_kenmerk : BusinessEntity
	{
		...
		private string sgt_alg_flexibel_kenmerk1Field;

		private Key sgt_alg_flexibel_kenmerkidField;
		...
		private Sgt_alg_flexibel_kenmerkStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_flexibel_kenmerk")] //, Order=7)]
		public string sgt_alg_flexibel_kenmerk1
		{
			get
			{
				return this.sgt_alg_flexibel_kenmerk1Field;
			}
			set
			{
				this.sgt_alg_flexibel_kenmerk1Field = value;
				base.RaisePropertyChanged("sgt_alg_flexibel_kenmerk1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_flexibel_kenmerkid
		{
			get
			{
				return this.sgt_alg_flexibel_kenmerkidField;
			}
			set
			{
				this.sgt_alg_flexibel_kenmerkidField = value;
				base.RaisePropertyChanged("sgt_alg_flexibel_kenmerkid");
			}
		}
		...
		public Sgt_alg_flexibel_kenmerkStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_flexibel_kenmerk()
		{
		}
	}
}