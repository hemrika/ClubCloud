...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_com_spelersdispensatie : TargetCreate
	{
		...
		public sgt_com_spelersdispensatie Sgt_com_spelersdispensatie
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_com_spelersdispensatie");
			}
		}

		public TargetCreateSgt_com_spelersdispensatie()
		{
		}
	}
}