...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_bouwaard : BusinessEntity
	{
		...
		private string sgt_alg_bouwaard1Field;

		private Key sgt_alg_bouwaardidField;
		...
		private Sgt_alg_bouwaardStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_bouwaard")] //, Order=7)]
		public string sgt_alg_bouwaard1
		{
			get
			{
				return this.sgt_alg_bouwaard1Field;
			}
			set
			{
				this.sgt_alg_bouwaard1Field = value;
				base.RaisePropertyChanged("sgt_alg_bouwaard1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_bouwaardid
		{
			get
			{
				return this.sgt_alg_bouwaardidField;
			}
			set
			{
				this.sgt_alg_bouwaardidField = value;
				base.RaisePropertyChanged("sgt_alg_bouwaardid");
			}
		}
		...
		public Sgt_alg_bouwaardStateInfo statecode
		{
			get
			{
