...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class TargetCreateSgt_smp_sitemap_toegang_knltb : TargetCreate
	{
		...
		public sgt_smp_sitemap_toegang_knltb Sgt_smp_sitemap_toegang_knltb
		{
			...
			set
			{
				...
				base.RaisePropertyChanged("Sgt_smp_sitemap_toegang_knltb");
			}
		}

		public TargetCreateSgt_smp_sitemap_toegang_knltb()
		{
		}
	}
}