...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_reden_afgekeurd : BusinessEntity
	{
		...
		private string sgt_alg_reden_afgekeurd1Field;

		private Key sgt_alg_reden_afgekeurdidField;
		...
		private Sgt_alg_reden_afgekeurdStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_reden_afgekeurd")] //, Order=7)]
		public string sgt_alg_reden_afgekeurd1
		{
			get
			{
				return this.sgt_alg_reden_afgekeurd1Field;
			}
			set
			{
				this.sgt_alg_reden_afgekeurd1Field = value;
				base.RaisePropertyChanged("sgt_alg_reden_afgekeurd1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_reden_afgekeurdid
		{
			get
			{
				return this.sgt_alg_reden_afgekeurdidField;
			}
			set
			{
				this.sgt_alg_reden_afgekeurdidField = value;
				base.RaisePropertyChanged("sgt_alg_reden_afgekeurdid");
			}
		}
		...
		public Sgt_alg_reden_afgekeurdStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_reden_afgekeurd()
		{
		}
	}
}