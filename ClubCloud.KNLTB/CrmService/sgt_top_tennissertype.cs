...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_top_tennissertype : BusinessEntity
	{
		...
		private string sgt_top_tennissertype1Field;

		private Key sgt_top_tennissertypeidField;

		private string sgt_verkorte_codeField;

		private Sgt_top_tennissertypeStateInfo statecodeField;
		...
		[XmlElement("sgt_top_tennissertype")] //, Order=10)]
		public string sgt_top_tennissertype1
		{
			get
			{
				return this.sgt_top_tennissertype1Field;
			}
			set
			{
				this.sgt_top_tennissertype1Field = value;
				base.RaisePropertyChanged("sgt_top_tennissertype1");
			}
		}

		[XmlElement] //[XmlElement(Order=11)]
		public Key sgt_top_tennissertypeid
		{
			get
			{
				return this.sgt_top_tennissertypeidField;
			}
			set
			{
				this.sgt_top_tennissertypeidField = value;
				base.RaisePropertyChanged("sgt_top_tennissertypeid");
			}
		}
		...
		public Sgt_top_tennissertypeStateInfo statecode
		{
			get
			{
