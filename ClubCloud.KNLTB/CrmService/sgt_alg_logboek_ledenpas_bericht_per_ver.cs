...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_logboek_ledenpas_bericht_per_ver : BusinessEntity
	{
		...
		private Key sgt_alg_logboek_ledenpas_bericht_per_veridField;
		...
		private Sgt_alg_logboek_ledenpas_bericht_per_verStateInfo statecodeField;
		...
		public Key sgt_alg_logboek_ledenpas_bericht_per_verid
		{
			get
			{
				return this.sgt_alg_logboek_ledenpas_bericht_per_veridField;
			}
			set
			{
				this.sgt_alg_logboek_ledenpas_bericht_per_veridField = value;
				base.RaisePropertyChanged("sgt_alg_logboek_ledenpas_bericht_per_verid");
			}
		}
		...
		public Sgt_alg_logboek_ledenpas_bericht_per_verStateInfo statecode
		{
			get
			{
		...
		public sgt_alg_logboek_ledenpas_bericht_per_ver()
		{
		}
	}
}