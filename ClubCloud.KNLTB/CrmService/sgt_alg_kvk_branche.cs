...
namespace ClubCloud.KNLTB.ServIt.CrmService
{
	...
	public class sgt_alg_kvk_branche : BusinessEntity
	{
		...
		private string sgt_alg_kvk_branche1Field;

		private Key sgt_alg_kvk_brancheidField;
		...
		private Sgt_alg_kvk_brancheStateInfo statecodeField;
		...
		[XmlElement("sgt_alg_kvk_branche")] //, Order=7)]
		public string sgt_alg_kvk_branche1
		{
			get
			{
				return this.sgt_alg_kvk_branche1Field;
			}
			set
			{
				this.sgt_alg_kvk_branche1Field = value;
				base.RaisePropertyChanged("sgt_alg_kvk_branche1");
			}
		}

		[XmlElement] //[XmlElement(Order=8)]
		public Key sgt_alg_kvk_brancheid
		{
			get
			{
				return this.sgt_alg_kvk_brancheidField;
			}
			set
			{
				this.sgt_alg_kvk_brancheidField = value;
				base.RaisePropertyChanged("sgt_alg_kvk_brancheid");
			}
		}
		...
		public Sgt_alg_kvk_brancheStateInfo statecode
		{
			get
			{
