<%@ Page language="C#" MasterPageFile="clouds.master" Inherits="Microsoft.SharePoint.WebPartPages.WebPartPage,Microsoft.SharePoint,Version=15.0.0.0,Culture=neutral,PublicKeyToken=71e9bce111e9429c" meta:progid="SharePoint.WebPartPage.Document" meta:webpartpageexpansion="full"  %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
	<div id="login">
		<div style="width: 400px; padding: 50px 35px; background: hsl(0, 0%, 100%); color: #0072C6; color: #0072C6; line-height: 18px !important; font: 500 12px/18px 'Futura', Arial, sans-serif; letter-spacing: 1px; text-align: center;" id="rome-error">
		    <h1 id="pageTitle" class="lined">Heldere hemel</h1>
		    <p class="description">The gevraagde pagina is niet gevonden</p>
		    <p>404</p>
		<p>
