...
{
    public abstract class ClubCloudDataSourceView : DataSourceView, IStateManager
    {
        ...
        internal ClubCloud.Service.ClubCloudServiceClient Client
        {
            get
            {
                if (_client == null)
        ...
        internal static void ObjectToTableConvert(Object p_obj, ref DataSet p_ds, String p_tableName)
        {
