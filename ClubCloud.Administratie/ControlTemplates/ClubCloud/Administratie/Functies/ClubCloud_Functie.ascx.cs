namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_FunctieUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ClubCloud_Functie_DataSource.ViewName = this.ViewName;
            ClubCloud_Functie_DataSource.Assembly = typeof(ClubCloud_FunctieUserControl).Assembly;
    	...
    	protected void SelectFunctieform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
    	{
    	...
    	protected void GoEdit(object sender, EventArgs e)
    	{
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Functie_Edit.aspx?Id={0}&IsDlg=1", btn.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Functie_Edit.aspx?Id={0}", btn.CommandArgument.ToString()));
        ...
        {
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Functie_Edit.aspx?Id={0}&IsDlg=1", e.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Functie_Edit.aspx?Id={0}", e.CommandArgument.ToString()));
        }
    }
}
