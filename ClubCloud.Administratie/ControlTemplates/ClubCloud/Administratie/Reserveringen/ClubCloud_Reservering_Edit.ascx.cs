        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(value != null)
            {
                ...
                if(Guid.TryParse(value,out DefaultValue))
                    ClubCloud_Reservering_DataSource.View.WhereParameters.Add(new Parameter { DefaultValue = "{" + DefaultValue.ToString() + "}", Name = "Id", DbType = DbType.Guid, Direction = ParameterDirection.Input });
            }
        }
