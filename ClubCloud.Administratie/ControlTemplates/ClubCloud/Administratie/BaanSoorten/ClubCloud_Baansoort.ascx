...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClubCloud_Baansoort.ascx.cs" Inherits="ClubCloud.Administratie.WebControls.ClubCloud_BaansoortUserControl" %>
...
<asp:FormView runat="server" ID="SelectBaansoortform" DefaultMode="ReadOnly" RenderOuterTable="False" OnCallingDataMethods="SelectBaansoortform_CallingDataMethods" SelectMethod="SelectBaansoort" DataKeyNames="Id" >
    <EmptyDataTemplate>
        <h1 class="title-regular clearfix">
            Geen Baansoort gevonden
		</h1>
        <div class="notice">
            Sorry, er is geen  Baansoort beschikbaar voor dit Id.</div>
        <asp:Button ID="btn_goback" CausesValidation="false" runat="server" Text="Terug naar Baansoorten" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button" />
    </EmptyDataTemplate>
	...
	<span style="display:inline-block;" >
		<asp:LinkButton CssClass="button big"  ID="btn_goback_top" runat="server" Text="Terug naar Baansoorten" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
		...
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Baanblokken.aspx?BaansoortId=<%# Eval("Id") %>', title:'Baanblokken van <%# Eval("Naam") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Baanblokken" >Baanblokken</a>
	</span>
    </HeaderTemplate>
    <FooterTemplate>
		<asp:LinkButton CssClass="button big"  ID="btn_goback_bottom" runat="server" Text="Terug naar Baansoorten" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
