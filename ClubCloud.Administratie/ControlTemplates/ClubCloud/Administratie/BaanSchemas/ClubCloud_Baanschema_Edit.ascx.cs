namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Baanschema_EditUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ClubCloud_Baanschema_DataSource.ViewName = this.ViewName;
            ClubCloud_Baanschema_DataSource.Assembly = typeof(ClubCloud_Baanschema_EditUserControl).Assembly;
        ...
        protected void EditBaanschemaform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
        {
    	...
    	protected void UpdateBaanschemaform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Baanschema.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Baanschema.aspx?Id={0}", value));
