namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Baanschemas_View : ClubCloudDataSourceView
    {
    	...
    	*/
        ...
        {
    		using (new SPMonitoredScope("Baanschemas SelectBaanschemas"))
            {
        ...
        {
    		using (new SPMonitoredScope("Baanschemas SelectBaan"))
            {
        ...
        {
    		using (new SPMonitoredScope("Baanschemas SelectMaandBegin"))
            {
        ...
        {
    		using (new SPMonitoredScope("Baanschemas SelectMaandEinde"))
            {
        ...
        {
    		using (new SPMonitoredScope("Baanschemas SelectDag"))
            {
    	...
    	*/
    	...
    	{
    		using (new SPMonitoredScope("Baanschemas InsertBaanschema"))
            {
