...
<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Baanschema_Insert.aspx', title:'Toevoegen Baanschema'});" href="#" target="_self" title="Toevoegen" >Toevoegen Baanschema</a>
<br/>
...
<SharePoint:SPGridView 
    ...
    <Columns>
		<asp:TemplateField>
			...
			<ItemTemplate>
                <a id="<%# Eval("Id") %>" title="<%# Eval("Id") %>" name="<%# Eval("Id") %>" onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Baanschema.aspx?Id='+'<%# Eval("Id") %>', title:'Details van '+'<%# Eval("Id") %>', autoSize:true});" style="white-space:nowrap;" href="#" >
                    <%# Eval("Id") %>
                </a>
			</ItemTemplate>
		</asp:TemplateField>
