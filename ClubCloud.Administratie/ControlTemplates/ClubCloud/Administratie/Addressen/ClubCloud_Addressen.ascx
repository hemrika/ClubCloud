...
<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Address_Insert.aspx', title:'Toevoegen Address'});" href="#" target="_self" title="Toevoegen" >Toevoegen Address</a>
<br/>
...
<SharePoint:SPGridView 
    ...
    <Columns>
		<asp:TemplateField>
			...
			<ItemTemplate>
                <a id="<%# Eval("Naam") %>" title="<%# Eval("Naam") %>" name="<%# Eval("Naam") %>" onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Address.aspx?Id='+'<%# Eval("Id") %>', title:'Details van '+'<%# Eval("Naam") %>', autoSize:true});" style="white-space:nowrap;" href="#" >
                    <%# Eval("Naam") %>
                </a>
			</ItemTemplate>
		</asp:TemplateField>
