...
<asp:FormView runat="server" ID="SelectAddressform" DefaultMode="ReadOnly" RenderOuterTable="False" OnCallingDataMethods="SelectAddressform_CallingDataMethods" SelectMethod="SelectAddress" DataKeyNames="Id" >
	...
	<span style="display:inline-block;" >
		<asp:LinkButton CssClass="button big"  ID="btn_goback_top" runat="server" Text="Terug naar Addressen" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
    ...
    <FooterTemplate>
		<asp:LinkButton CssClass="button big"  ID="btn_goback_bottom" runat="server" Text="Terug naar Addressen" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
