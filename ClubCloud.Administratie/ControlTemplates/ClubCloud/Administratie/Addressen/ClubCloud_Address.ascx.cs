namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_AddressUserControl : UserControl
    {
    	...
    	protected void SelectAddressform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
    	{
    	...
    	protected void GoEdit(object sender, EventArgs e)
    	{
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Address_Edit.aspx?Id={0}&IsDlg=1", btn.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Address_Edit.aspx?Id={0}", btn.CommandArgument.ToString()));
        ...
        {
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Address_Edit.aspx?Id={0}&IsDlg=1", e.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Address_Edit.aspx?Id={0}", e.CommandArgument.ToString()));
        }
    }
}
