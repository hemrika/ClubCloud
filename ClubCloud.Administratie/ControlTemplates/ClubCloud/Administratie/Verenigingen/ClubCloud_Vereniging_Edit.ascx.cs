namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Vereniging_EditUserControl : UserControl
    {
    	...
    	protected void UpdateVerenigingform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Vereniging.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Vereniging.aspx?Id={0}", value));
