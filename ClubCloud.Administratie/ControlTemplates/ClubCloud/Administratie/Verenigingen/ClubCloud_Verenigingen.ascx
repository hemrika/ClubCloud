...
<SharePoint:MenuTemplate ID="VerenigingMenu" runat="server" LargeIconMode="true">
    ...
    <SharePoint:MenuItemTemplate ID="Functionarissen" runat="server" Text="Functionarissen" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Functionarissen.aspx?VerenigingId=%Id%',title:'Functionarissen', autoSize:true});" Title="Functionarissen"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Lidmaatschappen" runat="server" Text="Lidmaatschappen" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschappen.aspx?VerenigingId=%Id%',title:'Lidmaatschappen', autoSize:true});" Title="Lidmaatschappen"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Bestuursorganen" runat="server" Text="Bestuursorganen" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Bestuursorganen.aspx?VerenigingId=%Id%',title:'Bestuursorganen', autoSize:true});" Title="Bestuursorganen"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Addressen" runat="server" Text="Addressen" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Addressen.aspx?VerenigingId=%Id%',title:'Addressen', autoSize:true});" Title="Addressen"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Afhangen" runat="server" Text="Afhangen" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Afhangen.aspx?VerenigingId=%Id%',title:'Afhangen', autoSize:true});" Title="Afhangen"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Sponsoren" runat="server" Text="Sponsoren" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Sponsoren.aspx?VerenigingId=%Id%',title:'Sponsoren', autoSize:true});" Title="Sponsoren"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Baanschemas" runat="server" Text="Baanschemas" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Baanschemas.aspx?VerenigingId=%Id%',title:'Baanschemas', autoSize:true});" Title="Baanschemas"></SharePoint:MenuItemTemplate>
    <SharePoint:MenuItemTemplate ID="Lidmaatschapsoorten" runat="server" Text="Lidmaatschapsoorten" ImageUrl="/_layouts/15/images/ClubCloud.Administratie/Contact/Contact_32.png" ClientOnClickScript="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschapsoorten.aspx?VerenigingId=%Id%',title:'Lidmaatschapsoorten', autoSize:true});" Title="Lidmaatschapsoorten"></SharePoint:MenuItemTemplate>
</SharePoint:MenuTemplate>
<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Vereniging_Insert.aspx', title:'Toevoegen Vereniging'});" href="#" target="_self" title="Toevoegen" >Toevoegen Vereniging</a>
<br/>
...
<SharePoint:SPGridView 
    ...
    <Columns>
		<asp:TemplateField>
			...
			<ItemTemplate>
                <a id="<%# Eval("Naam") %>" title="<%# Eval("Naam") %>" name="<%# Eval("Naam") %>" onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Vereniging.aspx?Id='+'<%# Eval("Id") %>', title:'Details van '+'<%# Eval("Naam") %>', autoSize:true});" style="white-space:nowrap;" href="#" >
                    <%# Eval("Naam") %>
                </a>
			</ItemTemplate>
		</asp:TemplateField>
