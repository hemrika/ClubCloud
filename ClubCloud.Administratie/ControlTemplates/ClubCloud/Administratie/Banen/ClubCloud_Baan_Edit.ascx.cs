namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Baan_EditUserControl : UserControl
    {
    	...
    	protected void UpdateBaanform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
                Baan_Validator.ErrorMessage = e.Exception.Message;
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Baan.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Baan.aspx?Id={0}", value));
