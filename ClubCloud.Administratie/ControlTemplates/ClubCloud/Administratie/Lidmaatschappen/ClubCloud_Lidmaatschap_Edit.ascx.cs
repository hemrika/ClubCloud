namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Lidmaatschap_EditUserControl : UserControl
    {
    	...
    	protected void UpdateLidmaatschapform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
                Lidmaatschap_Validator.ErrorMessage = e.Exception.Message;
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Lidmaatschap.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Lidmaatschap.aspx?Id={0}", value));
