...
<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschap_Insert.aspx', title:'Toevoegen Lidmaatschap', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Toevoegen" >Toevoegen Lidmaatschap</a>
<br/>
...
<SharePoint:SPGridView 
    ...
    <Columns>
		<asp:TemplateField>
			...
			<ItemTemplate>
                <a id="<%# Eval("Bondsnummer") %>" title="<%# Eval("Bondsnummer") %>" name="<%# Eval("Bondsnummer") %>" onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschap.aspx?Id='+'<%# Eval("Id") %>', title:'Details van '+'<%# Eval("Bondsnummer") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" style="white-space:nowrap;" href="#" >
                    <%# Eval("Bondsnummer") %>
                </a>
			</ItemTemplate>
		</asp:TemplateField>
