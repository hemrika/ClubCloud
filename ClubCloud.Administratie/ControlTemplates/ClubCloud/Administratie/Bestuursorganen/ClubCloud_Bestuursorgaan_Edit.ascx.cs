namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Bestuursorgaan_EditUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ClubCloud_Bestuursorgaan_DataSource.ViewName = this.ViewName;
            ClubCloud_Bestuursorgaan_DataSource.Assembly = typeof(ClubCloud_Bestuursorgaan_EditUserControl).Assembly;
        ...
        protected void EditBestuursorgaanform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
        {
    	...
    	protected void UpdateBestuursorgaanform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Bestuursorgaan.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Bestuursorgaan.aspx?Id={0}", value));
