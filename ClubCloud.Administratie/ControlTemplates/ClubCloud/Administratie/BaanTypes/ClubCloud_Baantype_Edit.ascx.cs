namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Baantype_EditUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ClubCloud_Baantype_DataSource.ViewName = this.ViewName;
            ClubCloud_Baantype_DataSource.Assembly = typeof(ClubCloud_Baantype_EditUserControl).Assembly;
        ...
        protected void EditBaantypeform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
        {
    	...
    	protected void UpdateBaantypeform_ItemUpdated(object sender, FormViewUpdatedEventArgs e)
        {
    		/*
            if (e.Exception != null)
            {
    		...
    		*/
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
        		Response.Redirect(string.Format("Baantype.aspx?Id={0}&IsDlg=1", value));
        
            Response.Redirect(string.Format("Baantype.aspx?Id={0}", value));
