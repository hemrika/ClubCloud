...
<asp:FormView runat="server" ID="InsertGebruikerform" DefaultMode="Insert" RenderOuterTable="False" OnCallingDataMethods="InsertGebruikerform_CallingDataMethods" SelectMethod="SelectGebruiker" InsertMethod="InsertGebruiker" DataKeyNames="Id" OnItemInserted="InsertGebruikerform_ItemInserted">
    <EmptyDataTemplate>
    ...
    <HeaderTemplate>
        <asp:LinkButton CssClass="button big" ID="btn_goback_top" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);"/>
        <asp:LinkButton CssClass="button big" ID="btn_update_top" runat="server" Text="Save" CommandName="Insert" CausesValidation="true" />
    </HeaderTemplate>
    <FooterTemplate>
        <asp:LinkButton CssClass="button big" ID="btn_goback_bottom" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);"/>
    ...
    <InsertItemTemplate>
        <fieldset>
			...
			<ajaxToolkit:CalendarExtender ID="Geboortedatum_CalendarExtender" runat="server" BehaviorID="Geboortedatum_CalendarExtender" TargetControlID="Geboortedatum" />
