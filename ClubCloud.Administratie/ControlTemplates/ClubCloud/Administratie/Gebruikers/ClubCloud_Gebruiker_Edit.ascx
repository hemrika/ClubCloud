...
<asp:FormView runat="server" ID="EditGebruikerform" DefaultMode="Edit" RenderOuterTable="False" OnCallingDataMethods="EditGebruikerform_CallingDataMethods" SelectMethod="SelectGebruiker" UpdateMethod="UpdateGebruiker" DataKeyNames="Id">
    <EmptyDataTemplate>
    ...
    <HeaderTemplate>
        <asp:Button ID="btn_goback_top" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClick="GoBack" OnCommand="GoBack" CommandArgument='<%# Eval("Id") %>'/>
        <asp:Button ID="btn_update_top" runat="server" Text="Save" CommandName="Update" CausesValidation="true" />
    </HeaderTemplate>
    <FooterTemplate>
        <asp:Button ID="btn_goback_bottom" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClick="GoBack" OnCommand="GoBack" CommandArgument='<%# Eval("Id") %>'/>
    ...
    <EditItemTemplate>
        <fieldset>
			...
			Geslacht : <asp:DropDownList ID="Geslacht" runat="server" DataTextField="Key" DataValueField="Value" SelectedValue='<%# Bind("Geslacht") %>' SelectMethod="SelectGeslacht" OnCallingDataMethods="EditGebruikerform_CallingDataMethods" /></br>
