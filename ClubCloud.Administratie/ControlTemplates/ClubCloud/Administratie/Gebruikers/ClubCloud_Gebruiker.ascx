...
<asp:FormView runat="server" ID="SelectGebruikerform" DefaultMode="ReadOnly" RenderOuterTable="False" OnCallingDataMethods="SelectGebruikerform_CallingDataMethods" SelectMethod="SelectGebruiker" DataKeyNames="Id" >
	...
	<span style="display:inline-block;" >
		...
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Functionarissen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Functionarissen van <%# Eval("Volledigenaam") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Functionarissen" >Functionarissen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschappen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Lidmaatschappen van <%# Eval("Volledigenaam") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Lidmaatschappen" >Lidmaatschappen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Addressen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Addressen van <%# Eval("Volledigenaam") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Addressen" >Addressen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Profielen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Profielen van <%# Eval("Volledigenaam") %>', autoSize:true, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Profielen" >Profielen</a>
	</span>
    </HeaderTemplate>
    <FooterTemplate>
