...
<asp:FormView runat="server" ID="SelectGebruikerform" DefaultMode="ReadOnly" RenderOuterTable="False" OnCallingDataMethods="SelectGebruikerform_CallingDataMethods" SelectMethod="SelectGebruiker" DataKeyNames="Id" >
	...
	<span style="display:inline-block;" >
		<asp:LinkButton CssClass="button big"  ID="btn_goback_top" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
		...
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Functionarissen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Functionarissen van <%# Eval("Volledigenaam") %>', autoSize:false, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Functionarissen" >Functionarissen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Lidmaatschappen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Lidmaatschappen van <%# Eval("Volledigenaam") %>', autoSize:false, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Lidmaatschappen" >Lidmaatschappen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Addressen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Addressen van <%# Eval("Volledigenaam") %>', autoSize:false, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Addressen" >Addressen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Profielen.aspx?GebruikerId=<%# Eval("Id") %>', title:'Profielen van <%# Eval("Volledigenaam") %>', autoSize:false, dialogReturnValueCallback:RefreshOnDialogClose});" href="#" target="_self" title="Profielen" >Profielen</a>
	</span>
    </HeaderTemplate>
    <FooterTemplate>
		<asp:LinkButton CssClass="button big"  ID="btn_goback_bottom" runat="server" Text="Terug naar Gebruikers" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);" SkinID="Button"/>
