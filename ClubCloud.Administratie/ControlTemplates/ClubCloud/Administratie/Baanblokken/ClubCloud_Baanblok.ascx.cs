namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_BaanblokUserControl : UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ClubCloud_Baanblok_DataSource.ViewName = this.ViewName;
            ClubCloud_Baanblok_DataSource.Assembly = typeof(ClubCloud_BaanblokUserControl).Assembly;
    	...
    	protected void SelectBaanblokform_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
    	{
    	...
    	protected void GoEdit(object sender, EventArgs e)
    	{
            ...
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Baanblok_Edit.aspx?Id={0}&IsDlg=1", btn.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Baanblok_Edit.aspx?Id={0}", btn.CommandArgument.ToString()));
        ...
        {
            if(Request.QueryString.AllKeys.Contains("IsDlg"))
    			Response.Redirect(string.Format("Baanblok_Edit.aspx?Id={0}&IsDlg=1", e.CommandArgument.ToString()));
    
            Response.Redirect(string.Format("Baanblok_Edit.aspx?Id={0}", e.CommandArgument.ToString()));
        }
    }
}
