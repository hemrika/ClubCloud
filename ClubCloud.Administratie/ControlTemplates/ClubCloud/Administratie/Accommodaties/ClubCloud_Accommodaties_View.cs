namespace ClubCloud.Administratie.WebControls
{
    ...
    public partial class ClubCloud_Accommodaties_View : ClubCloudDataSourceView
    {
    	...
    	*/
        ...
        {
    		using (new SPMonitoredScope("Accommodaties SelectAccommodaties"))
            {
    			...
    			if(SPContext.Current.Web.CurrentUser != null)
    			{
    				...
    				if(Settings != null && Settings.VerenigingId != null) 
    				{
    					...
    					ClubCloud_Accommodatie_View queryresult = Client.GetAccommodatiesByQuery(bondsnummer.ToString(), Settings.VerenigingId.Value, new DataSourceSelectArguments{ MaximumRows = maximumRows, StartRowIndex = startRowIndex, RetrieveTotalRowCount = true, SortExpression = sortByExpression }, collection);
        ...
        {
    		using (new SPMonitoredScope("Accommodaties SelectBaanblok"))
            {
        ...
        {
    		using (new SPMonitoredScope("Accommodaties SelectBaan"))
            {
        ...
        {
    		using (new SPMonitoredScope("Accommodaties SelectActief"))
            {
    	...
    	*/
    	...
    	public int InsertAccommodatie(ClubCloud_Accommodatie entity)
    	{
    		using (new SPMonitoredScope("Accommodaties InsertAccommodatie"))
            {
