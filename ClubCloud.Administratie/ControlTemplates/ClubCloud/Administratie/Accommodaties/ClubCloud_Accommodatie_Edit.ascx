...
<asp:FormView runat="server" ID="EditAccommodatieform" DefaultMode="Edit" RenderOuterTable="False" OnCallingDataMethods="EditAccommodatieform_CallingDataMethods" SelectMethod="SelectAccommodatie" UpdateMethod="UpdateAccommodatie" DataKeyNames="Id">
    <EmptyDataTemplate>
    ...
    <HeaderTemplate>
        <asp:Button ID="btn_goback_top" runat="server" Text="Terug naar Accommodaties" CausesValidation="false" OnClick="GoBack" OnCommand="GoBack" CommandArgument='<%# Eval("Id") %>'/>
        <asp:Button ID="btn_update_top" runat="server" Text="Save" CommandName="Update" CausesValidation="true" />
    </HeaderTemplate>
    <FooterTemplate>
        <asp:Button ID="btn_goback_bottom" runat="server" Text="Terug naar Accommodaties" CausesValidation="false" OnClick="GoBack" OnCommand="GoBack" CommandArgument='<%# Eval("Id") %>'/>
