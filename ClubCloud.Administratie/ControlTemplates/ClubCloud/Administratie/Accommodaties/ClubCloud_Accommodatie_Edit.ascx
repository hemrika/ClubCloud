...
<asp:FormView runat="server" ID="EditAccommodatieform" DefaultMode="Edit" RenderOuterTable="False" OnCallingDataMethods="EditAccommodatieform_CallingDataMethods" SelectMethod="SelectAccommodatie" UpdateMethod="UpdateAccommodatie" DataKeyNames="Id" OnItemUpdated="UpdateAccommodatieform_ItemUpdated">
    ...
    <EditItemTemplate>
        <fieldset>
			...
			Actief : <asp:DropDownList ID="Actief" runat="server" DataTextField="Value" DataValueField="Value" SelectedValue='<%# Bind("Actief") %>' SelectMethod="SelectActief" OnCallingDataMethods="EditAccommodatieform_CallingDataMethods" AppendDataBoundItems="true"><asp:ListItem  Text="Onbekend" Value="" Selected="True"></asp:ListItem> </asp:DropDownList></br>
