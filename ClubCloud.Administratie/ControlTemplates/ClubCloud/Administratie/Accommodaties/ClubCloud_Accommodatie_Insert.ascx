...
<asp:FormView runat="server" ID="InsertAccommodatieform" DefaultMode="Insert" RenderOuterTable="False" OnCallingDataMethods="InsertAccommodatieform_CallingDataMethods" SelectMethod="SelectAccommodatie" InsertMethod="InsertAccommodatie" DataKeyNames="Id" OnItemInserted="InsertAccommodatieform_ItemInserted">
    <EmptyDataTemplate>
    ...
    <HeaderTemplate>
        <asp:LinkButton CssClass="button big" ID="btn_goback_top" runat="server" Text="Terug naar Accommodaties" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);"/>
        <asp:LinkButton CssClass="button big" ID="btn_update_top" runat="server" Text="Save" CommandName="Insert" CausesValidation="true" />
    </HeaderTemplate>
    <FooterTemplate>
        <asp:LinkButton CssClass="button big" ID="btn_goback_bottom" runat="server" Text="Terug naar Accommodaties" CausesValidation="false" OnClientClick="javascript:SP.UI.ModalDialog.commonModalDialogClose(SP.UI.DialogResult.OK, null);"/>
