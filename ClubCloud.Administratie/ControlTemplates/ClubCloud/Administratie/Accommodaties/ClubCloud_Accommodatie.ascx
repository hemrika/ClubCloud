...
<asp:FormView runat="server" ID="SelectAccommodatieform" DefaultMode="ReadOnly" RenderOuterTable="False" OnCallingDataMethods="SelectAccommodatieform_CallingDataMethods" SelectMethod="SelectAccommodatie" DataKeyNames="Id" >
	...
	<span style="display:inline-block;" >
		...
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Baanblokken.aspx?AccommodatieId=<%# Eval("Id") %>', title:'Baanblokken van <%# Eval("Naam") %>', autoSize:true});" href="#" target="_self" title="Baanblokken" >Baanblokken</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Banen.aspx?AccommodatieId=<%# Eval("Id") %>', title:'Banen van <%# Eval("Naam") %>', autoSize:true});" href="#" target="_self" title="Banen" >Banen</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'BanenSpeciaal.aspx?AccommodatieId=<%# Eval("Id") %>', title:'BanenSpeciaal van <%# Eval("Naam") %>', autoSize:true});" href="#" target="_self" title="BanenSpeciaal" >BanenSpeciaal</a>
		<a class="button big"  onclick="javascript:SP.UI.ModalDialog.showModalDialog({url:'Addressen.aspx?AccommodatieId=<%# Eval("Id") %>', title:'Addressen van <%# Eval("Naam") %>', autoSize:true});" href="#" target="_self" title="Addressen" >Addressen</a>
	</span>
    </HeaderTemplate>
    <FooterTemplate>
