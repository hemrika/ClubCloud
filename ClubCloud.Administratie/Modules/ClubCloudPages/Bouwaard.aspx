...
<%@ Register TagPrefix="ClubCloud" TagName="Bouwaard" Src="~/_controltemplates/ClubCloud/Administratie/Bouwaarden/ClubCloud_Bouwaard.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Bouwaard
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Bouwaard id="Bouwaarden" runat="server" visible="true" ViewName="ClubCloud_Bouwaarden_View" />
