...
<%@ Register TagPrefix="ClubCloud" TagName="Rechtsvorm_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Rechtsvormen/ClubCloud_Rechtsvorm_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Rechtsvorm - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Rechtsvorm_Edit id="Rechtsvormen" runat="server" visible="true" ViewName="ClubCloud_Rechtsvormen_View" />
