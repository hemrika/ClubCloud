...
<%@ Register TagPrefix="ClubCloud" TagName="Baantype" Src="~/_controltemplates/ClubCloud/Administratie/Baantypes/ClubCloud_Baantype.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baantype
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baantype id="Baantypes" runat="server" visible="true" ViewName="ClubCloud_Baantypes_View" />
