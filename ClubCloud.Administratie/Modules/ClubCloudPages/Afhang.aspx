...
<%@ Register TagPrefix="ClubCloud" TagName="Afhang" Src="~/_controltemplates/ClubCloud/Administratie/Afhangen/ClubCloud_Afhang.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Afhang
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Afhang id="Afhangen" runat="server" visible="true" ViewName="ClubCloud_Afhangen_View" />
