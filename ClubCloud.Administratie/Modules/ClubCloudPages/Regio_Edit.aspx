...
<%@ Register TagPrefix="ClubCloud" TagName="Regio_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Regios/ClubCloud_Regio_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Regio - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Regio_Edit id="Regios" runat="server" visible="true" ViewName="ClubCloud_Regios_View" />
