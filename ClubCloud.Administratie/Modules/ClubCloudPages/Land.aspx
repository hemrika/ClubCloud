...
<%@ Register TagPrefix="ClubCloud" TagName="Land" Src="~/_controltemplates/ClubCloud/Administratie/Landen/ClubCloud_Land.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Land
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Land id="Landen" runat="server" visible="true" ViewName="ClubCloud_Landen_View" />
