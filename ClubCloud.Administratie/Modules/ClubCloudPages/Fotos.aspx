...
<%@ Register TagPrefix="ClubCloud" TagName="Fotos" Src="~/_controltemplates/ClubCloud/Administratie/Fotos/ClubCloud_Fotos.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Fotos
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Fotos" name="Fotos" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Fotos id="Fotos" runat="server" visible="true" ViewName="ClubCloud_Fotos_View" />
