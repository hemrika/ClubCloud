...
<%@ Register TagPrefix="ClubCloud" TagName="Addressen" Src="~/_controltemplates/ClubCloud/Administratie/Addressen/ClubCloud_Addressen.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Addressen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Addressen" name="Addressen" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Addressen id="Addressen" runat="server" visible="true" ViewName="ClubCloud_Addressen_View" />
