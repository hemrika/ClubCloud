...
<%@ Register TagPrefix="ClubCloud" TagName="District" Src="~/_controltemplates/ClubCloud/Administratie/Districten/ClubCloud_District.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - District
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:District id="Districten" runat="server" visible="true" ViewName="ClubCloud_Districten_View" />
