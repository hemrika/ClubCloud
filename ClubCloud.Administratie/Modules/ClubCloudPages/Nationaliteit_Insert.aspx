...
<%@ Register TagPrefix="ClubCloud" TagName="Nationaliteit_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Nationaliteiten/ClubCloud_Nationaliteit_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Nationaliteit - Toevoegen
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Nationaliteit_Insert id="Nationaliteiten" runat="server" visible="true" ViewName="ClubCloud_Nationaliteiten_View" />
