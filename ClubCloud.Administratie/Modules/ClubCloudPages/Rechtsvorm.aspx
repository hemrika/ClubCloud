...
<%@ Register TagPrefix="ClubCloud" TagName="Rechtsvorm" Src="~/_controltemplates/ClubCloud/Administratie/Rechtsvormen/ClubCloud_Rechtsvorm.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Rechtsvorm
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Rechtsvorm id="Rechtsvormen" runat="server" visible="true" ViewName="ClubCloud_Rechtsvormen_View" />
