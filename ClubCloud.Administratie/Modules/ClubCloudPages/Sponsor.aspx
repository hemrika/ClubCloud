...
<%@ Register TagPrefix="ClubCloud" TagName="Sponsor" Src="~/_controltemplates/ClubCloud/Administratie/Sponsoren/ClubCloud_Sponsor.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Sponsor
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Sponsor id="Sponsoren" runat="server" visible="true" ViewName="ClubCloud_Sponsoren_View" />
