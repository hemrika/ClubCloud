...
<%@ Register TagPrefix="ClubCloud" TagName="Baantoplaag" Src="~/_controltemplates/ClubCloud/Administratie/Baantoplagen/ClubCloud_Baantoplaag.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baantoplaag
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baantoplaag id="Baantoplagen" runat="server" visible="true" ViewName="ClubCloud_Baantoplagen_View" />
