...
<%@ Register TagPrefix="ClubCloud" TagName="Land_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Landen/ClubCloud_Land_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Land - Toevoegen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Land" name="Land" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Land_Insert id="Landen" runat="server" visible="true" ViewName="ClubCloud_Landen_View" />
