...
<%@ Register TagPrefix="ClubCloud" TagName="Gebruiker" Src="~/_controltemplates/ClubCloud/Administratie/Gebruikers/ClubCloud_Gebruiker.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Gebruiker
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Gebruiker id="Gebruikers" runat="server" visible="true" ViewName="ClubCloud_Gebruikers_View" />
