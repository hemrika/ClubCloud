...
<%@ Register TagPrefix="ClubCloud" TagName="Foto_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Fotos/ClubCloud_Foto_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Foto - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Foto_Edit id="Fotos" runat="server" visible="true" ViewName="ClubCloud_Fotos_View" />
