...
<%@ Register TagPrefix="ClubCloud" TagName="Foto_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Fotos/ClubCloud_Foto_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Foto - Toevoegen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Foto" name="Foto" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Foto_Insert id="Fotos" runat="server" visible="true" ViewName="ClubCloud_Fotos_View" />
