...
<%@ Register TagPrefix="ClubCloud" TagName="Foto" Src="~/_controltemplates/ClubCloud/Administratie/Fotos/ClubCloud_Foto.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Foto
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Foto id="Fotos" runat="server" visible="true" ViewName="ClubCloud_Fotos_View" />
