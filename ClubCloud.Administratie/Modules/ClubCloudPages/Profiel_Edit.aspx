...
<%@ Register TagPrefix="ClubCloud" TagName="Profiel_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Profielen/ClubCloud_Profiel_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Profiel - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Profiel_Edit id="Profielen" runat="server" visible="true" ViewName="ClubCloud_Profielen_View" />
