...
<%@ Register TagPrefix="ClubCloud" TagName="Baansoort" Src="~/_controltemplates/ClubCloud/Administratie/Baansoorten/ClubCloud_Baansoort.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baansoort
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baansoort id="Baansoorten" runat="server" visible="true" ViewName="ClubCloud_Baansoorten_View" />
