...
<%@ Register TagPrefix="ClubCloud" TagName="Baanschema" Src="~/_controltemplates/ClubCloud/Administratie/Baanschemas/ClubCloud_Baanschema.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baanschema
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baanschema id="Baanschemas" runat="server" visible="true" ViewName="ClubCloud_Baanschemas_View" />
