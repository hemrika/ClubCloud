...
<%@ Register TagPrefix="ClubCloud" TagName="Sponsoren" Src="~/_controltemplates/ClubCloud/Administratie/Sponsoren/ClubCloud_Sponsoren.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Sponsoren
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Sponsoren" name="Sponsoren" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Sponsoren id="Sponsoren" runat="server" visible="true" ViewName="ClubCloud_Sponsoren_View" />
