...
<%@ Register TagPrefix="ClubCloud" TagName="Regio_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Regios/ClubCloud_Regio_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Regio - Toevoegen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Regio" name="Regio" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Regio_Insert id="Regios" runat="server" visible="true" ViewName="ClubCloud_Regios_View" />
