...
<%@ Register TagPrefix="ClubCloud" TagName="Gebruikers" Src="~/_controltemplates/ClubCloud/Administratie/Gebruikers/ClubCloud_Gebruikers.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Gebruikers
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Gebruikers" name="Gebruikers" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Gebruikers id="Gebruikers" runat="server" visible="true" ViewName="ClubCloud_Gebruikers_View" />
