...
<%@ Register TagPrefix="ClubCloud" TagName="Profielen" Src="~/_controltemplates/ClubCloud/Administratie/Profielen/ClubCloud_Profielen.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Profielen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Profielen" name="Profielen" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Profielen id="Profielen" runat="server" visible="true" ViewName="ClubCloud_Profielen_View" />
