...
<%@ Register TagPrefix="ClubCloud" TagName="Landen" Src="~/_controltemplates/ClubCloud/Administratie/Landen/ClubCloud_Landen.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Landen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Landen" name="Landen" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Landen id="Landen" runat="server" visible="true" ViewName="ClubCloud_Landen_View" />
