...
<%@ Register TagPrefix="ClubCloud" TagName="Address_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Addressen/ClubCloud_Address_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Address - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Address_Edit id="Addressen" runat="server" visible="true" ViewName="ClubCloud_Addressen_View" />
