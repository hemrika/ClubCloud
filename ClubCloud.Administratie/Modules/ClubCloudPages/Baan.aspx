...
<%@ Register TagPrefix="ClubCloud" TagName="Baan" Src="~/_controltemplates/ClubCloud/Administratie/Banen/ClubCloud_Baan.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baan
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baan id="Banen" runat="server" visible="true" ViewName="ClubCloud_Banen_View" />
