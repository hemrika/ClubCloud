...
<%@ Register TagPrefix="ClubCloud" TagName="Districten" Src="~/_controltemplates/ClubCloud/Administratie/Districten/ClubCloud_Districten.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Districten
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Districten" name="Districten" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Districten id="Districten" runat="server" visible="true" ViewName="ClubCloud_Districten_View" />
