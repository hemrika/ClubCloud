...
<%@ Register TagPrefix="ClubCloud" TagName="Functies" Src="~/_controltemplates/ClubCloud/Administratie/Functies/ClubCloud_Functies.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Functies
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Functies" name="Functies" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
