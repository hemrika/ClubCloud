...
<%@ Register TagPrefix="ClubCloud" TagName="Baan_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Banen/ClubCloud_Baan_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Baan - Toevoegen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Baan" name="Baan" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Baan_Insert id="Banen" runat="server" visible="true" ViewName="ClubCloud_Banen_View" />
