...
<%@ Register TagPrefix="ClubCloud" TagName="Setting_Edit" Src="~/_controltemplates/ClubCloud/Administratie/Settings/ClubCloud_Setting_Edit.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Setting - Bewerken
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Setting_Edit id="Settings" runat="server" visible="true" ViewName="ClubCloud_Settings_View" />
