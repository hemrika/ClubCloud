...
<%@ Register TagPrefix="ClubCloud" TagName="Functie" Src="~/_controltemplates/ClubCloud/Administratie/Functies/ClubCloud_Functie.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Functie
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Functie id="Functies" runat="server" visible="true" ViewName="ClubCloud_Functies_View" />
