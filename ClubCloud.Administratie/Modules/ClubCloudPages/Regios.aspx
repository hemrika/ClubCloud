...
<%@ Register TagPrefix="ClubCloud" TagName="Regios" Src="~/_controltemplates/ClubCloud/Administratie/Regios/ClubCloud_Regios.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Regios
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Regios" name="Regios" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Regios id="Regios" runat="server" visible="true" ViewName="ClubCloud_Regios_View" />
