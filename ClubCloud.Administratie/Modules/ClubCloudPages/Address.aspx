...
<%@ Register TagPrefix="ClubCloud" TagName="Address" Src="~/_controltemplates/ClubCloud/Administratie/Addressen/ClubCloud_Address.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Address
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Address id="Addressen" runat="server" visible="true" ViewName="ClubCloud_Addressen_View" />
