...
<%@ Register TagPrefix="ClubCloud" TagName="Profiel" Src="~/_controltemplates/ClubCloud/Administratie/Profielen/ClubCloud_Profiel.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Profiel
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Profiel id="Profielen" runat="server" visible="true" ViewName="ClubCloud_Profielen_View" />
