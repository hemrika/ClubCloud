...
<%@ Register TagPrefix="ClubCloud" TagName="Regio" Src="~/_controltemplates/ClubCloud/Administratie/Regios/ClubCloud_Regio.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Regio
</asp:Content>
            ...
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Regio id="Regios" runat="server" visible="true" ViewName="ClubCloud_Regios_View" />
