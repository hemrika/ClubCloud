...
<%@ Register TagPrefix="ClubCloud" TagName="Settings" Src="~/_controltemplates/ClubCloud/Administratie/Settings/ClubCloud_Settings.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Settings
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Settings" name="Settings" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Settings id="Settings" runat="server" visible="true" ViewName="ClubCloud_Settings_View" />
