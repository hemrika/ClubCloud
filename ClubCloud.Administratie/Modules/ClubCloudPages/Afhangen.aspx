...
<%@ Register TagPrefix="ClubCloud" TagName="Afhangen" Src="~/_controltemplates/ClubCloud/Administratie/Afhangen/ClubCloud_Afhangen.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Afhangen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Afhangen" name="Afhangen" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Afhangen id="Afhangen" runat="server" visible="true" ViewName="ClubCloud_Afhangen_View" />
