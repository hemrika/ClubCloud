...
<%@ Register TagPrefix="ClubCloud" TagName="Afhang_Insert" Src="~/_controltemplates/ClubCloud/Administratie/Afhangen/ClubCloud_Afhang_Insert.ascx" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    ClubCloud - <SharePoint:ProjectProperty Property="Title" runat="server"/> - Afhang - Toevoegen
</asp:Content>
<asp:Content ID="Main" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <div class="inner dark" id="Afhang" name="Afhang" style="padding:20px 20px 10px">
        <div class="services">
            <div class="first" >
                <div class="info">
					<Provider:ZimbraRolesSecurityTrimmedControl RolesString="All Authenticated Users" runat="server" ID="security" >
						<ClubCloud:Afhang_Insert id="Afhangen" runat="server" visible="true" ViewName="ClubCloud_Afhangen_View" />
